...
string get_desc()
{
    return "Song Tử là 1 trong 12 cung Hoàng Đạo. Khi được triệu hồi, sẽ giúp chủ nhân gia tăng thêm 5% Ngoại Kháng, "
           "5% Nội Kháng, 5% Khí Huyết, 5% Bạo Kích.";
}

string get_short()
{
    return "Song Tử là 1 trong 12 cung Hoàng Đạo. Khi được triệu hồi, sẽ giúp chủ nhân gia tăng thêm 5% Ngoại Kháng, "
           "5% Nội Kháng, 5% Khí Huyết, 5% Bạo Kích, Thời gian giới hạn 14 ngày. Nhận được sẽ tự phong ấn.";
}
...
int get_use_effect_callout(object me, object item)
{
    ...
    if (size)
    {
        for (index = 0; index < size; index++)
        {
            ...
            send_user(get_scene_object_2(zombie, USER_TYPE), "%c%w%w%w%c%c%c", 0x4f, get_x(zombie), get_y(zombie), 9414,
                      1, OVER_BODY, PF_ONCE);
...
string get_pet_desc()
{
    return "Chủ nhân gia tăng thêm 5% Ngoại Kháng, 5% Nội Kháng, 5% Khí Huyết, 5% Bạo Kích";
}
