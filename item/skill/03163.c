...
string get_desc() 
{ 
        return "Bộ sách ghi lại Kĩ năng cấp 150 của Đào Hoa Nguyên \nSau khi sử dụng sẽ học được kĩ năng cấp 150 Phi Long Tại Thiên \nKim Cương Bất Hoại."; 
}
...
// 函数：获取特技标志
string get_perform_id() { return "03163"; }

// 函数：获取技能名称
string get_skill_name() { return "Kim Cương Bất Hoại"; }
