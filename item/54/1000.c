...
int get_item_number() {return 10001051 ;}
...
string get_desc() 
{ 
        return "Duy trì biến hình thành Mông Diện Nhân trong vòng 1 tiếng, đồng thời nâng cao 2% thân thủ."; 
}
