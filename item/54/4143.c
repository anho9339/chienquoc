...
int get_item_number() {return 10001061 ;}
...
string get_desc() 
{ 
        return "Duy trì biến hình thành Thần Tướng trong vòng 1 tiếng, đồng thời nâng cao 2% Ngoại Công."; 
}
