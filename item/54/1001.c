...
int get_item_number() {return 10001052 ;}
...
string get_desc() 
{ 
        return "Duy trì biến hình thành Thích Khách trong vòng 1 tiếng, đồng thời nâng cao 2% Thân Thủ."; 
}
