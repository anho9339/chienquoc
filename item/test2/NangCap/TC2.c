...
int move_item_callout(object me, object item, object equip, int type)
{
	...
	{
		write_user(me, ECHO "Chỉ có thể Nâng Cấp Thú Cưỡi và Chiến Thú dưới cấp 4!");
		return 1;
	}
	...
	equip->get_name()=="★ Chiến Thú Tiểu Quai cấp 3 ★"	)	
{
	...
	equip1 = new("item/ride/NangCap/001_4");
	p = equip1->move2(me,-1);
	...
	equip->get_name()=="★ Chiến Thú Đinh Đang cấp 3 ★"	)	
{
	...
	equip1 = new("item/ride/NangCap/002_4");
	p = equip1->move2(me,-1);
	equip1->add_to_user(p);
	...
	equip->get_name()=="★ Chiến Thú Đà Đà cấp 3 ★"	)	
{
	...
	equip1 = new("item/ride/NangCap/003_4");
	p = equip1->move2(me,-1);
	equip1->add_to_user(p);
	...
	equip->get_name()=="★ Chiến Thú Bọ Hung cấp 3 ★"	)	
{
	...
	equip1 = new("item/ride/NangCap/004_4");
	p = equip1->move2(me,-1);
	equip1->add_to_user(p);
	...
	equip->get_name()=="★ Chiến Thú Bàn Bàn cấp 3 ★"	)	
{
	...
	equip1 = new("item/ride/NangCap/005_4");
	p = equip1->move2(me,-1);
	equip1->add_to_user(p);
	...
	equip->get_name()=="★ Chiến Thú Tử Mao cấp 3 ★"	)	
{
	...
	equip1 = new("item/ride/NangCap/006_4");
	p = equip1->move2(me,-1);
	equip1->add_to_user(p);
	...
	equip->get_name()=="★ Chiến Thú Bổn Bổn cấp 3 ★"	)	
{
	...
	equip1 = new("item/ride/NangCap/007_4");
	p = equip1->move2(me,-1);
	equip1->add_to_user(p);
	...
	equip->get_name()=="★ Chiến Thú Thần Ngư cấp 3 ★"	)	
{
	...
	equip1 = new("item/ride/NangCap/055_4");
	p = equip1->move2(me,-1);
	equip1->add_to_user(p);
