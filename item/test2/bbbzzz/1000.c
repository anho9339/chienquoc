...
string get_desc() 
{ 
        return "Sử dụng sẽ tăng 150 triệu Bang ngân của Phái"; 
}
...
int get_use_effect_callout( object who,object item) 
{
	...
	send_user( who, "%c%c%w%s", ':', 3, 0,sprintf("Sử dụng sẽ tăng 150 triệu Bang Ngân Bang Phái, muốn sử dụng không？\n"ESC"Xác nhận\nuse ! %x#\n"ESC"Huỷ bỏ",getoid(item))); 
	return 0;
}
