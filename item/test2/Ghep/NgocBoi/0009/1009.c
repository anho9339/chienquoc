...
string get_desc()
{
        return " \n★★★ \nNgọc Bội tín vật của Thỏ Tiên, có thể tăng tín vật lên cấp 4\n Cấp 45 mới sử dụng được。";
}
...
int get_use_effect_callout( object me, object item )
{
	...
	send_user(me, "%c%c%w%s", ':', 3, 0, "Thỏ Thần Ngọc Bội sau khi sử dụng sẽ biến mất \n Bạn muốn sử dụng không????\n"+ESC+"Chấp nhận\n"+sprintf("use ! %x#\n", getoid(item))+ESC+"Hủy bỏ\nCLOSE\n");
	return 0;
}
