...
string get_desc() 
{ 
        return "Túi quà có được khi tham gia sự kiện, \nsử dụng sẽ nhận được Ngân lượng, \n3 quyển Bí kíp Nhập môn, Sơ Cấp Đoạn Thạch."; 
}
...
int get_use_effect_callout( object who,object gift) 
{
	...
	//	p = item->move2(who);
	//	item->add_to_user(p);
	send_user(who,"%c%s",';',sprintf("Bạn nhận được %d lượng, %s, %s, %s, Sơ Cấp Đoạn Thạch.", cash, item1->get_name(), item2->get_name(), item3->get_name()));	
