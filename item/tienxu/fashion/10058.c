...
int get_item_value() {return 1300 ;}
int get_item_value_2() {return 1300 ;}
int get_item_color() { return 2; }

// 函数：构造处理
void create()
{
        set_name("Lãng Tử Chiến Y (Nam)");
        set_picid_1(10058);
        set_picid_2(10058);
		...
		set_fashion_code(58);
		//set_fashion_color_1(ID Màu Sắc); 
}

// 函数：获取描述
string get_desc()
{
        return "Phong trần lãng tử đào hoa kiếp.";
}
