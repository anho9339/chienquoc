...
string get_desc() 
{ 
        return "Lập tức hồi phục 950 điểm Khí Huyết, 1050 điểm Pháp Lực";
}
...
int get_use_effect_callout( object me )
{
	...
	send_user( me, "%c%c%c%w", 0x30, get_item_type_2(), 0, ITEM_USE_TIME );    // 更新使用间隔
        me->add_hp( 950 * ( 100 + me->get_healing_rate() ) / 100 );        
        me->add_mp( 1050 * ( 100 + me->get_healing_rate() ) / 100 );        
