...
#define ADD_DAMAGE      200

// 函数：叠加上限
int get_max_combined() { return 30; }

// 函数：成品编号
int get_fin_type() { return 1602; }
...
{ 
	...
	if (me->get_skill(660)<SKILL_LEVEL) color = HIR + sprintf("要求机关等级：%d\n", SKILL_LEVEL);
	else color = sprintf("要求机关等级：%d\n", SKILL_LEVEL);
        return  color + "土制炸弹，对目标3X3范围内的敌对方造成200点伤害";
}
