...
string get_desc() 
{ 
        return "Một loại thuốc trị vết thương thời xưa thường sử dụng lúc hành quân chiến đấu, lập tức hồi phục 200 điểm khí huyết, thời gian tái sử dụng 15 giây";
}
