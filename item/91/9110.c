...
// 函数：成品编号
int get_fin_type() { return 1817; }

// 函数：构造处理
void create()
{
        set_name( "Chính Khí Tán" );
        set_picid_1(9110);
        set_picid_2(9110);
        set_unit( "包" );
        set_value(280);
...
string get_desc() 
{ 
        return "Một loại thuốc viên lúc làm phép thường sử dụng, lập tức hồi phục 150 điểm sức mạnh pháp thuật, thời gian tái sử dụng 15 giây";
}
...
int get_use_effect_callout( object me )
{
	...
	send_user( me, "%c%c%c%w", 0x30, get_item_type_2(), 0, ITEM_USE_TIME );    // 更新使用间隔  
        ...
        me->add_mp( 150 * ( 100 + me->get_healing_rate() ) / 100 );
