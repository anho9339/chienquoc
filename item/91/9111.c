...
string get_desc() 
{ 
        return "Một loại thuốc viên có thể làm cho thần và người sử dụng định tâm ,\n lập tức hồi phục 450 điểm Pháp Lực, thời gian tái sử dụng 15 giây";
}
