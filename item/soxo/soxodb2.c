...
string get_desc()
{ 
        return "Vé Số Đặc Biệt 2, có tỉ lệ ra được vật phẩm đặc biệt và ngân lượng cao."; 
}
...
int get_use_effect_callout( object who,object gift) 
{
	...
	rate = random(100);
		...
		who->add_cash(18000+random(1000));
		send_user(who,"%c%s",'!',sprintf("Bạn nhận được lượng lớn ngân lượng."));
		}

		else if (rate<70)
		who->add_exp(18000+random(1000));

		else if (rate<80) {
		who->add_cash(15000+random(1000));
