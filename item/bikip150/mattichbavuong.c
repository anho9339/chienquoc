...
void create()
{
        set_name("Túi Mật Tịch Bá Vương");
        set_picid_1(3104);
        set_picid_2(3104);
        set_value(5000);
		set_save("mt150",10000);
}

// 函数：获取描述
string get_desc( object me ) 
{ 
        return "Sau khi sử dụng sẽ nhận được "HIY "Mật Tịch Bá Vương cấp 150"NOR " tương ứng Môn Phái";
}
...
//	weapon->add_to_user(p);
	item = new(sprintf("item/bikip150/bavuong/%d000",family));
	p = item->move2(who,-1);
	item->add_to_user(p);
