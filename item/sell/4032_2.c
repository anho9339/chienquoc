...
// 函数：宝石识别
int get_item_type() { return ITEM_TYPE_DIAMOND_97; }
...
void create()
{
        set_name("Đoạn Thạch Đặc Biệt Trung Cấp");
...
string get_desc() 
{
	return HIY"Chỉ có thể luyện trang bị 5 sao trở lên \n"HIY"Khi luyện thất bại cũng không bị giảm sao \n"HIY"Đoạn Thạch Đặc Biệt có xác xuất \n"HIY"tinh luyện thành công là 15％ \n"HIY"Sử dụng gói VIP sẽ tăng tỷ lệ thành công thêm 5％.";
}
...
int move_item_callout(object me, object item, object equip, int type)
{
	...
	if (level<5)
	{
		notify( "Đoạn Thạch Đặc Biệt chỉ rèn được trang bị 5 sao trở lên." );
		return 1;
	}	
	if (level>=10)
	{
