...
int move_item_callout(object me, object item, object equip, int type)
{
	...
	if (level<6)
	{
		notify( "Đoạn Thạch này chỉ rèn được trang bị 6 sao trở lên." );
		return 1;
	}
	if (level>=9)
	{
