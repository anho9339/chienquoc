...
string get_desc() 
{
	return HIY"Chỉ có thể luyện trang bị 6 sao trở lên \n"HIM"Đá của Tiên Đế. Không bao giờ rèn thất bại.";
}
...
int move_item_callout(object me, object item, object equip, int type)
{
	...
	if (level>=15)
	{
		notify( "Chỉ có thể rèn được tối đa 15 sao." );
		return 1;
	}	
	rate = 10000;		
	for (i=4;i<=level;i++)
