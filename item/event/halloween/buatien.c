...
{ 
	...
	object me = this_player();
        return  "Là loại bùa do các thần tiên ban tặng, \nCó thể dùng nó để tiêu diệt Tà Quỷ, mỗi lần dùng có thể gây ra ít nhất 200 sát thương.";
}
...
int get_use_effect_callout( object me, object who )
{
        ...
        {        
	        ...
	        send_user( get_scene_object_2(who, USER_TYPE), "%c%d%w%c%c%w%c%c%w%c%c%c", 0x6f, getoid(who), 27111, 1, OVER_BODY, 36351, 1, OVER_BODY, 9999, 1, OVER_BODY, PF_ONCE );	        
