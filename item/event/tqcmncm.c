...
{
		return "Túi Quà Chào Mừng người chơi mới \nKích chuột phải để sử dụng \nTúi quà Chào Mừng người chơi mới gia nhập CQTD.\n";
}
...
int get_use_effect_callout( object who,object gift) 
{
	...
	TASK_LEGEND_D->check_task_item1(who,"Túi Quà Chào Mừng",1);
	TASK_LEGEND_D->check_task_item2(who,"Túi Quà Chào Mừng",1);
	TASK_LEGEND_D->check_task_item3(who,"Túi Quà Chào Mừng",1); 
	TASK_LEGEND_D->check_task_item4(who,"Túi Quà Chào Mừng",1);
