...
#define THIS_PERFORM    05914
#define PF_START       "05914"
#define PF_TIME        "05914#"
#define PF_NAME        "Kim Giáp Thần Công"

#define SKILL_LEVEL     150
#define TIME_INTERVAL   3
#define SUB_MP          300 + (me->get_skill(THIS_SKILL) - SKILL_LEVEL)/150*2
#define ADD_AP		1000 + (me->get_skill(THIS_SKILL) - SKILL_LEVEL)/150*15000
...
string get_desc( object me )
{
        ...
        if (level<SKILL_LEVEL)
        	return HIR + PF_NAME +"\n Võ công yêu cầu: 150 cấp\n    Thần Công Hộ Thể,Tuyệt kỹ bí truyền của Vân Mộng Cốc. Gia tăng 1000 Ngoại Kháng và Nội Kháng trong vòng 60 phút.";
        cur_level = (level - SKILL_LEVEL)/150 + 1;
        result = sprintf(HIC" %s (Cấp %d )\n " NOR "Võ công yêu cầu: Cấp %d \n Pháp Lực tiêu hao: %d điểm\n Tái sử dụng sau: %d giây\n    Thần Công Hộ Thể,Tuyệt kỹ bí truyền của Vân Mộng Cốc. Gia tăng %d Ngoại Kháng và Nội Kháng trong vòng 60 phút.\n " HIC"Cấp tiếp theo:\n "NOR "Võ công yêu cầu: " HIR "Cấp %d " NOR "\n    Thần Công Hộ Thể, Gia tăng %d Ngoại Kháng và Nội Kháng trong vòng 60 phút.",
...
{
        return "Gia tăng Ngoại Kháng.\n";
}

// 函数:获取描述(持续)
string get_loop_desc2( object me )
{
        return "Gia tăng Nội Kháng.\n";
}
...
int main( object me, object who, int x, int y, string arg )
{
		...
		if (me->get_save("05914")==0) return 1;
