...
#define PF_NAME        "Linh Khí Hộ Thể"

#define SKILL_LEVEL     5
#define TIME_INTERVAL   2
#define SUB_MP        ( 90 + ( me->get_skill(THIS_SKILL)-SKILL_LEVEL) / 10 * 40 )
...
string get_desc( object me )
{
        ...
        result = sprintf(HIC" %s (Cấp %d )\n " NOR "Võ công yêu cầu: Cấp %d \n Pháp Lực tiêu hao: %d điểm\n Tái sử dụng sau: %d giây\n    Dùng chân nguyên linh khí để hộ thể, trong 30 giây có thể phòng thủ được %d điểm sát thương.\n " HIC"Cấp tiếp theo:\n "NOR"Võ công yêu cầu: " HIR "Cấp %d " NOR"\n    Trong 30 giây có thể phòng thủ được %d điểm sát thương.",
