...
#define PF_NAME        "Uỷ Mị Kiếm Pháp"
...
string get_desc( object me )
{
        ...
        if (level<SKILL_LEVEL)
        	return sprintf(HIR " %s \n Võ công yêu cầu: Cấp 150\n Tuyệt kĩ kiếm pháp của Vân Mộng Cốc, vừa uỷ mị vừa mạnh mẽ tấn công nhiều mục tiêu", PF_NAME);
        cur_level = (level - SKILL_LEVEL)/150 + 1;
        size = 9 + (level/ 80 )*50;
        result = sprintf(HIC" %s (Cấp %d )\n " NOR "Võ công yêu cầu: Cấp %d \n Pháp Lực tiêu hao: %d điểm\n Tái sử dụng sau: %d giây\n Tuyệt kĩ kiếm pháp vừa uỷ mị vừa mạnh mẽ của Vân Mộng Cốc, tăng thêm %d điểm Nội Công khi biến hóa thành vô số ảo ảnh sát thương %d mục tiêu trong tầm nhìn.\n " HIC"Cấp tiếp theo:\n "NOR "Võ công yêu cầu: " HIR "Cấp %d " NOR "\n    Tăng thêm %d điểm Nội Công，Biến hoá thành %d ảo ảnh sát thương mục tiêu. ", 
