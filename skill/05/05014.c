...
#define THIS_PERFORM    05014
#define PF_START       "05014"
#define PF_TIME        "05014#"
#define PF_NAME        "Cường Thể Thuật"

#define SKILL_LEVEL     20
#define TIME_INTERVAL   2
#define SUB_MP          ( 50 + ( me->get_skill(THIS_SKILL)-SKILL_LEVEL) / 10 * 20 )
#define ADD_EFFECT      ( 50 + ( me->get_skill(THIS_SKILL)-SKILL_LEVEL) / 10 * 40 )
...
string get_desc( object me )
{
        ...
        result = sprintf(HIC" %s (Cấp %d )\n " NOR "Võ công yêu cầu: Cấp %d \n Pháp Lực tiêu hao: %d điểm\n Tái sử dụng sau: %d giây\n    Đạo thuật tráng kiện cơ thể, trong 15 phút có thể tăng thêm %d điểm Khí Huyết tối đa cho đồng đội.\n " HIC"Cấp tiếp theo:\n "NOR"Võ công yêu cầu: " HIR "Cấp %d " NOR"\n    Đạo thuật tráng kiện cơ thể, trong 15 phút có thể tăng thêm %d điểm Khí Huyết tối đa cho đồng đội.",
        	PF_NAME, cur_level, SKILL_LEVEL, SUB_MP, TIME_INTERVAL, ADD_EFFECT, cur_level*10+SKILL_LEVEL, ADD_EFFECT+40 );
	return result;
}
