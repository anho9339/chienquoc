...
#define THIS_PERFORM    05917
#define PF_START       "05917"
#define PF_TIME        "05917#"
#define PF_NAME        "Từ Bi Tế Vũ"

#define SKILL_LEVEL     150
#define TIME_INTERVAL   10
#define SUB_MP          ( 0 + ( me->get_skill(THIS_SKILL)-SKILL_LEVEL) / 150 * 20 )
#define ADD_EFFECT      ( 1200 + ( me->get_skill(THIS_SKILL)-SKILL_LEVEL) / 150 * 20000 )
...
string get_desc( object me )
{
        ...
        if (level<SKILL_LEVEL)
        	return HIR + PF_NAME +"\n Võ công yêu cầu: 10 cấp\n    Dùng kim châm hội tụ nguyên khí, trong 60 phút có thể tăng thêm 1200 điểm Nội Công cho đồng đội";
...
int main( object me, object who, int x, int y, string arg )
{
	...
	object owner;
		...
		if (me->get_save("05917")==0) return 1;
