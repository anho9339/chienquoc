...
#define PF_NAME        "Ngân Châm Độ Ách"
...
string get_desc( object me )
{
        ...
        result = sprintf(HIC" %s (Cấp %d )\n " NOR "Võ công yêu cầu: Cấp %d \n Pháp Lực tiêu hao: %d điểm\n Tái sử dụng sau: %d giây\n    Dùng ngân châm đả thông kinh mạch, trong 15 phút có thể tăng thêm %d điểm Ngoại Công cho đồng đội.\n " HIC"Cấp tiếp theo:\n "NOR "Võ công yêu cầu: " HIR "Cấp %d " NOR "\n    Liên tục 15 phút Tăng thêm %d Ngoại Công.",
