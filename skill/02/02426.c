...
#define THIS_PERFORM    02426
#define PF_START       "02426"
#define PF_TIME        "02426#"
#define PF_NAME        "Từ Bi Tế Vũ"

#define SKILL_LEVEL     150
#define TIME_INTERVAL   10
#define SUB_MP          ( 0 + ( me->get_skill(THIS_SKILL)-SKILL_LEVEL) / 150 * 2 )
#define ADD_EFFECT      ( 2000 + ( me->get_skill(THIS_SKILL)-SKILL_LEVEL) / 150 * 20000 )
...
int main( object me, object who, int x, int y, string arg )
{
	...
	object owner;
		...
		if (me->get_save("02426")==0) return 1;
