...
#define THIS_PERFORM    02125
#define PF_START       "02125"
#define PF_TIME        "02125#"
#define PF_NAME        "Sư Tử Gầm"
...
string get_desc( object me )
{
        ...
        if (level<SKILL_LEVEL)
        	return sprintf(HIR " %s \n Võ công yêu cầu: Cấp 150\n Tiếng thét sư tử như trời long đất lỡ,khiến các đối thủ xung quanh bị choáng trong 4 giây.", PF_NAME);
        result = sprintf(HIC" %s \n " NOR "Võ công yêu cầu: Cấp %d \n Nguyên khí tiêu hao: %d điểm\n Tái sử dụng sau: %d giây\n Tiếng thét sư tử như trời long đất lỡ,khiến các đối thủ xung quanh bị choáng trong 4 giây.", 
...
int main( object me, object who, int x, int y, string arg )
{
		...
		if (me->get_save("02125")==0) return 1;
...
int cast_done_npc( object me )
{
        ...
        z = get_z(me);  x = get_x(me);  y = get_y(me);
        char = get_range_object(z, x, y, 15, USER_TYPE) + get_range_object(z, x, y, 15, CHAR_TYPE) - ({ me });
