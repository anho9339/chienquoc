...
#define THIS_PERFORM    03290
#define PF_START       "03290"
#define PF_TIME        "03290#"
...
string get_desc( object me )
{
        ...
        if (level<SKILL_LEVEL)
        	return HIR + PF_NAME +"\n Võ công yêu cầu: 10 cấp\n    Dùng kim châm hội tụ nguyên khí, trong 60 phút có thể tăng thêm 2000 điểm Nội Công cho đồng đội";
...
int main( object me, object who, int x, int y, string arg )
{
	...
	object owner;
		...
		if (me->get_save("03290")==0) return 1;
