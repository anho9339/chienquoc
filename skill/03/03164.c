...
#define THIS_PERFORM    03164
#define PF_START       "03164"
#define PF_TIME        "03164#"
...
string get_desc( object me )
{
        ...
        if (level<SKILL_LEVEL)
        	return HIR + PF_NAME +"\n Võ công yêu cầu: 150 cấp\n    Dùng ngân châm đả thông kinh mạch, trong 60 phút có thể tăng thêm 2000 điểm Ngoại Công cho bản thân và đồng đội";
...
int main( object me, object who, int x, int y, string arg )
{
	...
	object owner;
		...
		if (me->get_save("03164")==0) return 1;
