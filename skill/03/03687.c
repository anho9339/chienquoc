...
#define THIS_PERFORM    03687
#define PF_START       "03687"
#define PF_TIME        "03687#"
#define PF_NAME        "Dịch Cân Kinh"

#define SKILL_LEVEL     150
#define TIME_INTERVAL   30
#define SUB_MP          ( 5000 + ( me->get_skill(THIS_SKILL)-SKILL_LEVEL) / 150 * 2 )
#define ADD_EFFECT      ( 20000 + ( me->get_skill(THIS_SKILL)-SKILL_LEVEL) / 150 * 120000 )
...
string get_desc( object me )
{
        ...
        if (level<SKILL_LEVEL)
        	return HIR + PF_NAME +"\n Võ công yêu cầu: 150 cấp\n    Bí pháp độc môn bí ẩn Đường Môn,có khả năng gia tăng 20 ngàn Khí Huyết trong 60 phút";
        cur_level = (level - SKILL_LEVEL)/150 + 1;
        result = sprintf(HIC" %s (Cấp %d )\n " NOR "Võ công yêu cầu: Cấp %d \n Pháp Lực tiêu hao: %d điểm\n Tái sử dụng sau: %d giây\n    Bí pháp độc môn bí ẩn Đường Môn,có khả năng gia tăng %d Khí Huyết trong 60 phút。\n " HIC"Cấp tiếp theo:\n "NOR "Võ công yêu cầu: " HIR "Cấp %d " NOR "\n    Bí pháp độc môn bí ẩn Đường Môn,có khả năng gia tăng %d Khí Huyết trong 60 phút。",
        	PF_NAME, cur_level, SKILL_LEVEL, SUB_MP, TIME_INTERVAL, ADD_EFFECT, cur_level*150+SKILL_LEVEL, ADD_EFFECT+120000 );
	return result;
}
...
int main( object me, object who, int x, int y, string arg )
{
	...
	object owner;
		...
		if (me->get_save("03687")==0) return 1;
