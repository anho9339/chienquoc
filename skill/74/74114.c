...
// 函数：获取技能ID
int get_id() { return 74114; }
// 函数：获取技能类型
string get_name() { return "Cường Công"; }
// 函数：获取技能类型（0、被动；1、主动）
...
{
	return HIC+get_name()+"\n Kỹ năng của Bảo thú, tăng 10 % sát thương Ngoại Công hiện tại.\n";
}
// 函数：获取指令类型
...
{
	int point;
	if ( pet->get_skill(74205) )
		return ;
	point = pet->get_ap()/10;
	pet->set("sk74114",point);
