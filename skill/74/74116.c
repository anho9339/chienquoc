...
// 函数：获取技能类型
string get_name() { return "Độc Nha"; }
// 函数：获取技能类型（0、被动；1、主动）
...
{
	return HIC+get_name()+"\n Kỹ năng của Bảo thú, Khi công kích có 15 % tỷ lệ làm mục tiêu trúng độc, \nMỗi 2 giây rút 15 độc tính, liên tục 20 giây \nKĩ năng không hiệu quả chồng。";
}
// 函数：获取指令类型
