...
// 函数：获取技能ID
int get_id() { return 74221; }
// 函数：获取技能类型
string get_name() { return "Phúc Tinh Cao Chiếu"; }
// 函数：获取技能类型（0、被动；1、主动）
...
{
	return HIC+get_name()+"\n Kỹ năng của Bảo thú, bảo thú đang tấn công sẽ đạt được ngoại công cực đại \nNếu bị tấn công ngoại công sẽ giảm cực đại. ";
}
// 函数：获取指令类型
