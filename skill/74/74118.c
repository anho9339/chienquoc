...
// 函数：获取技能ID
int get_id() { return 74118; }
// 函数：获取技能类型
string get_name() { return "Ngự Hoả"; }
// 函数：获取技能类型（0、被动；1、主动）
...
{
	return HIC+get_name()+"\n Kỹ năng của Bảo thú, Gia tăng đề kháng hoả công 30% thương tổn.";
}
// 函数：获取指令类型
...
{
	if ( pet->get_skill(74209) )
		return ;	
	pet->set("anti_fire",30);
}
//删除技能的影响
