...
// 函数：获取技能ID
int get_id() { return 74204; }
// 函数：获取技能类型
string get_name() { return "Cao Cấp Bạo Tâm"; }
// 函数：获取技能类型（0、被动；1、主动）
...
{
	return HIC+get_name()+"\n Kỹ năng của Bảo thú, tăng 10 % Bạo kích hiện tại(Ngoại Công/Nội Công)\n";
}
// 函数：获取指令类型
...
{
	pet->set("sk74204",1000);
	NPC_PET_D->count_other(pet);
}
//删除技能的影响
