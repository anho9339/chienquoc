...
// 函数：获取技能ID
int get_id() { return 74120; }
// 函数：获取技能类型
string get_name() { return "Ngự Thổ"; }
// 函数：获取技能类型（0、被动；1、主动）
...
{
	return HIC+get_name()+"\n Kỹ năng của Bảo thú, tăng 30 % đề kháng với sát thương hệ Thổ.\n";
}
// 函数：获取指令类型
...
{
	if ( pet->get_skill(74211) )
		return ;
	pet->set("anti_dirt",30);
}
//删除技能的影响
