...
// 函数：获取技能ID
int get_id() { return 74117; }
// 函数：获取技能类型
string get_name() { return "Ngự Lôi"; }
// 函数：获取技能类型（0、被动；1、主动）
...
{
	return HIC+get_name()+"\n Kỹ năng của Bảo thú, Gia tăng đề kháng lôi công 30% thương tổn.";
}
// 函数：获取指令类型
...
{
	if ( pet->get_skill(74208) )
		return ;
	pet->set("anti_thunder",30);
}
//删除技能的影响
