...
#define THIS_SKILL      650				// 技能名字
#define THIS_SORT      	2				// 小类别	
#define THIS_PERFORM	604		
#define PF_NAME        "Hư Minh Hạng Liên Chế Tác"

#define SKILL_LEVEL     120
#define SKILL_EXP     	0	
#define SKILL_TOOL	517	
#define SUB_TILI	1				// 体力需求
#define SKILL_FINAL	"/item/final/86/2119"				// 制作的结果
#define SKILL_SEX	0				// 是否区分男女性别
#define SKILL_TEMP	1				// 是否一次性使用的技能
#define MASTER_NEED	0
#define FINAL_COLOR	2
#define BASE_RATE	75
