...
string get_desc( object me )
{
        ...
        if (level<SKILL_LEVEL)
        	return HIR + PF_NAME +"\n Võ công yêu cầu: 10 cấp\n Vật phẩm tiêu hao: 1 lá Bùa Giấy\n    Đạo thuật trói yêu, phong tỏa di chuyển của mục tiêu trong 6 giây. Pháp thuật không có tác dụng với người chơi khác";
...
void can_perform( object me )
{
	...
	send_user(me, "%c%w%w%c%c%c%c%c%s", 0x64, THIS_PERFORM, SUB_MP, 1, 10, MAGIC_ACT_BEGIN, 0, 9, "Bùa Giấy");
}
