...
#define THIS_PERFORM    04177
#define PF_START       "04177"
#define PF_TIME        "04177#"
#define PF_NAME        "Thuận Thiên Pháp Chú Cương Thi Vương"
...
#define ADD_RATE	( 50 + ( me->get_skill(THIS_SKILL)-SKILL_LEVEL) / 150 * 90 )
// 函数：获取符法效果
...
string get_desc( object me )
{
        ...
        if (level<SKILL_LEVEL)
        	return HIR + PF_NAME +"\n Võ công yêu cầu: 150 cấp\n    Hy sinh Triệu hồi thú của bản thân để triệu hồi “Cương Thi Vương” hỗ trợ chiến đấu. Mỗi lần tấn công Cương Thi Vương có 50％ khả năng làm cho kẻ địch bị Choáng trong 2 giây. Cương Thi Vương có thể duy trì xuất hiện trong 3 giờ。";
        cur_level = (level - SKILL_LEVEL)/150 + 1;
        result = sprintf(HIC" %s (Cấp %d )\n " NOR "Võ công yêu cầu: Cấp %d \n Pháp Lực tiêu hao: %d điểm\n Tái sử dụng sau: %d giây\n    Hy sinh Triệu hồi thú của bản thân để triệu hồi “Cương Thi Vương” hỗ trợ chiến đấu. Mỗi lần tấn công Cương Thi Vương có %d％ khả năng làm cho kẻ địch bị Choáng trong 10 giây. Cương Thi Vương có thể duy trì xuất hiện trong %d giây。\n " HIC"Cấp tiếp theo:\n "NOR "Võ công yêu cầu: " HIR "Cấp %d " NOR "\n    Tăng Cương Thi Vương thêm 1000000 điểm Khí Huyết；\n    Tăng Cương Thi Vương thêm 15000 điểm Ngoại Công；\n    Tăng Cương Thi Vương thêm 15000 điểm Ngoại Kháng；\n    Tăng Cương Thi Vương thêm 15000 điểm Nội Kháng；\n    Tăng Cương Thi Vương thêm 4000 điểm Thân Thủ。\n    Mỗi lần tấn công Cương Thi Vương có %d％ khả năng làm cho kẻ địch bị Choáng trong 10 giây. Cương Thi Vương có thể duy trì xuất hiện trong %d giây。", 
...
int main( object me, object who, int x, int y, string arg )
{
		...
		if (me->get_save("04177")==0) return 1;
...
int cast_done( object me )
{
	...
	destruct(who);	
	npc = new (sprintf("/npc/std/%d", 4136));
	if (!npc) return 2;
	level = me->get_skill(THIS_SKILL);
	npc->set_level(level);
	npc->set_name( sprintf( "Cương Thi Vương ( %s )", me->get_name() ) );
	npc->set_max_hp(100000+(level-40)/150*50000);
	npc->set_ap(10000+(level-40)/150*5000);
	npc->set_dp(7000+(level-40)/150*3000);
	npc->set_pp(7000+(level-40)/150*3000);
