...
#define THIS_PERFORM    04223
#define PF_START       "04223"
#define PF_TIME        "04223#"
#define PF_NAME        "Âm Dương Kim Cang Chú"
...
int main( object me, object who, int x, int y, string arg )
{
	...
	int i, size, time, pos;
		...
		if (me->get_save("04223")==0) return 1;
