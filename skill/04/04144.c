...
#define PF_NAME        "Thực Cốt"

#define SKILL_LEVEL     15
#define TIME_INTERVAL   2
#define SUB_MP          ( 15 + ( me->get_skill(THIS_SKILL)-SKILL_LEVEL) / 10 * 10 )
#define SUB_EFFECT      ( 15 + ( me->get_skill(THIS_SKILL)-SKILL_LEVEL) / 10 * 3 )
...
string get_desc( object me )
{
        ...
        if (level<SKILL_LEVEL)
        	return HIR + PF_NAME +"\n Võ công yêu cầu: 15 cấp\    Tà thuật ăn mòn xương cốt, khiến đối thủ bị giảm 15%% hiệu quả tấn công đối với mình trong suốt 120 giây.";
        cur_level = (level - SKILL_LEVEL)/10 + 1;
        result = sprintf(HIC" %s (Cấp %d )\n " NOR "Võ công yêu cầu: Cấp %d \n Pháp Lực tiêu hao: %d điểm\n Tái sử dụng sau: %d giây\n    Tà thuật ăn mòn xương cốt, khiến đối thủ bị giảm %d%% hiệu quả tấn công đối với mình trong suốt 120 giây.\n " HIC"Cấp tiếp theo:\n "NOR "Võ công yêu cầu: " HIR "Cấp %d " NOR "\n    Tà thuật ăn mòn xương cốt, khiến đối thủ bị giảm %d%% hiệu quả tấn công đối.",
