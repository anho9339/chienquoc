...
#define ADD_AP          ( 100 + ( me->get_skill(THIS_SKILL)-SKILL_LEVEL) / 10 * 15 )
...
string get_desc( object me )
{
        ...
        if (level<SKILL_LEVEL)
        	return HIR + PF_NAME +"\n Võ công yêu cầu: 12 cấp\n Vật phẩm tiêu hao: 1 lá Bùa Giấy\n    Hô gọi Ngự Lôi Thiên Sư tấn công địch thủ, tăng thêm 100 điểm Nội Công khi sát thương và làm mục tiêu bị Choáng trong 2 giây";
