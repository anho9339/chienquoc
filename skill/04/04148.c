...
#define SUB_EFFECT      ( 60 + ( me->get_skill(THIS_SKILL)-SKILL_LEVEL) / 10 * 50 )
...
string get_desc( object me )
{
        ...
        if (level<SKILL_LEVEL)
        	return HIR + PF_NAME +"\n Võ công yêu cầu: 26 cấp\    Tà thuật ăn mòn hồn phách làm kẻ thù địch trong vòng 8 giây tiêu hao Pháp Lực không ngừng, mỗi 2 giây mất 60 điểm Pháp Lực.";
        ...
        result = sprintf(HIC" %s (Cấp %d )\n " NOR "Võ công yêu cầu: Cấp %d \n Pháp Lực tiêu hao: %d điểm\n Tái sử dụng sau: %d giây\n    Tà thuật ăn mòn hồn phách làm kẻ thù địch trong vòng 8 giây tiêu hao Pháp Lực không ngừng, mỗi 2 giây mất %d điểm Pháp Lực.\n " HIC"Cấp tiếp theo:\n "NOR"Võ công yêu cầu: " HIR "Cấp %d " NOR"\n    Làm đối thủ tiêu hao Pháp Lực %d điểm. ",
        	PF_NAME, cur_level, SKILL_LEVEL, SUB_MP, TIME_INTERVAL, SUB_EFFECT, cur_level*10+SKILL_LEVEL, SUB_EFFECT + 50 );
	return result;
}
