...
#define THIS_PERFORM	492		
#define PF_NAME        "Phượng Thiên Chiến Cân Chế Tác"

#define SKILL_LEVEL     110
#define SKILL_EXP     	117	
#define SKILL_TOOL	512	
#define SUB_TILI	1				// 体力需求
#define SKILL_FINAL	"/item/final/65/2120"				// 制作的结果
