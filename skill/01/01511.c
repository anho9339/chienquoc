...
#define THIS_SKILL      0151
#define THIS_PERFORM    01511
#define PF_START       "01511"
#define PF_NAME        "Nghênh đầu loạn côn"

#define SKILL_LEVEL     10
#define TIME_INTERVAL   2
#define SUB_MP          7
#define ADD_AP          me->get_pf_value(THIS_SKILL, SKILL_LEVEL_SQUARE, 13, 330)    // 警告：me 得准备好
...
int perform_action( object me, object who )
{
        ...
        if( !CHAR_FIGHT_D->attack_action(me, who, 39) ) return 1;        
