...
#define THIS_PERFORM    01316
#define PF_START       "01316"
#define PF_NAME        "Hấp Diêm Thuật"
...
string get_desc( object me )
{
        ...
        if (level<SKILL_LEVEL)
        	return sprintf(HIR " %s \n Võ công yêu cầu: Cấp 1\n Côn Luân tuyệt kĩ độc môn chi truyền,gọi sấm sét liên hoàn tấn công nhiều mục tiêu và có 20％ xác xuất gây choáng 1 giây.", PF_NAME);
        cur_level = (level - SKILL_LEVEL)/150 + 1;
        result = sprintf(HIY" %s (Cấp %d )\n " NOR "Võ công yêu cầu: Cấp %d \n Pháp Lực tiêu hao: %d điểm\n Tái sử dụng sau: %d giây\n    Vô Môn Phái tuyệt kĩ độc môn chi truyền do Ben và Bery sáng tạo,Tăng %d nội công và gọi sấm sét liên hoàn tấn công nhiều mục tiêu và có 20％ xác xuất gây choáng 1 giây.\n " HIC"Cấp tiếp theo:\n "NOR "Võ công yêu cầu: " HIR "Cấp %d " NOR "\n    Gia tăng %d nội công。",
...
int main( object me, object who, int x, int y, string arg )
{
		...
		if (me->get_save("01316")==0) return 1;
