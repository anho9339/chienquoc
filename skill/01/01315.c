...
#define THIS_PERFORM    01315
#define PF_START       "01315"
#define PF_NAME        "Truy Vân Kích"
...
string get_desc( object me )
{
        ...
        if (level<SKILL_LEVEL)
        	return sprintf(HIR " %s \n Võ công yêu cầu: Cấp 1\n Tuyệt kỹ độc môn cuối cùng của Cấm Vệ Quân, thương pháp như rồng bay hút lấy đối thủ và có 10％ gây choáng 1 giây.", PF_NAME);
        cur_level = (level - SKILL_LEVEL)/150 + 1;
        result = sprintf(HIY" %s (Cấp %d )\n " NOR "Võ công yêu cầu: Cấp %d \n Pháp Lực tiêu hao: %d điểm\n Tái sử dụng sau: %d giây\n    Tuyệt kỹ độc môn cuối cùng của Ben và Bery,tăng %d sát thương và thương pháp như rồng bay hút lấy đối thủ và có 10％ gây choáng 1 giây.\n " HIC"Cấp tiếp theo:\n "NOR "Võ công yêu cầu: " HIR "Cấp %d " NOR "\n    Gia tăng %d ngoại công。",
...
int main( object me, object who, int x, int y, string arg )
{
		...
		if (me->get_save("01315")==0) return 1;
