...
#define THIS_SKILL      0121
#define THIS_PERFORM    01211
#define PF_START       "01211"
#define PF_NAME        "Đan đao trực nhập"

#define SKILL_LEVEL     10
#define TIME_INTERVAL   2
#define SUB_MP          6
#define ADD_AP          me->get_pf_value(THIS_SKILL, SKILL_LEVEL_SQUARE, 12, 340)    // 警告：me 得准备好
...
int perform_action( object me, object who )
{
        ...
        if( !CHAR_FIGHT_D->attack_action(me, who, 29) ) return 1;        
