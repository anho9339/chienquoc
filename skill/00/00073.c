...
#define THIS_PERFORM    00073
#define PF_START       "00073"
#define PF_NAME        "Tinh Nguyên Đơn 1"

// 函数：获取描述
string get_desc( object me ) 
{ 
        return "[ " PF_NAME " ]\n Shop Tinh Nguyên Đơn 1 (Nên để vào thanh phím tắt 2).\n "; 
}
...
if ( arg=="" )
		{	
	objs = children("/npc/test/CuaTiemTND1");	
