...
#define THIS_PERFORM    00074
#define PF_START       "00074"
#define PF_NAME        "Tinh Nguyên Đơn 2"

// 函数：获取描述
string get_desc( object me ) 
{ 
        return "[ " PF_NAME " ]\n Shop Tinh Nguyên Đơn 2 (Nên để vào thanh phím tắt 2).\n "; 
}
...
int main( object me, object who, int x, int y, string arg )
{
	...
	objs = children("/npc/test/CuaTiemTND2");
