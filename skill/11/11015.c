...
#define THIS_SKILL      11010
#define THIS_PERFORM    11010
...
int perform_action_npc( object me, object who )
{
	...
	SAY_CMD->say(me, "Loài người!Hãy mau xuống địa ngục!"); 
...
void into_effect(object me, string arg)
{
	...
	for(i=0;i<121;i++)		//发送效果
        ...
        char = get_range_object(z, x, y, 18, USER_TYPE) + get_range_object(z, x, y, 18, CHAR_TYPE) - ({ me });
