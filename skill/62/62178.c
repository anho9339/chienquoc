...
#define THIS_SKILL      620				// 技能名字
#define THIS_SORT      	5				// 小类别	
#define THIS_PERFORM	178		
#define PF_NAME        "Cửu Hoàn Kim Liên Côn Rèn"

#define SKILL_LEVEL     70
#define SKILL_EXP     	0	
#define SKILL_TOOL	501	
#define SUB_TILI	1				// 体力需求
#define SKILL_FINAL	"/item/final/75/1085"				// 制作的结果
