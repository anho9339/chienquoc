...
#define SUB_MP          ( 20000 + ( me->get_skill(THIS_SKILL)-SKILL_LEVEL) / 150 * 2 )
#define ADD_EFFECT      ( 20000 + ( me->get_skill(THIS_SKILL)-SKILL_LEVEL) / 150 * 20000 )
...
string get_desc( object me )
{
        ...
        if (level<SKILL_LEVEL)
        	return HIR + PF_NAME +"\n Võ công yêu cầu: 150 cấp\n    Dùng ngân châm đả thông kinh mạch, trong 60 phút có thể tăng thêm 20000 điểm Ngoại Công cho bản thân và đồng đội";
