...
#define THIS_SKILL      610				// 技能名字
#define THIS_SORT      	1				// 小类别	
#define THIS_PERFORM	%d		
#define PF_NAME        "%s"

#define SKILL_LEVEL     %d
#define SKILL_EXP     	%d	
#define SKILL_TOOL	%d	
#define SUB_TILI	1				// 体力需求
#define SKILL_FINAL	%s				// 制作的结果
#define SKILL_SEX	0				// 是否区分男女性别
#define SKILL_TEMP	%d				// 是否一次性使用的技能
#define MASTER_NEED	0
#define FINAL_COLOR	%d
#define BASE_RATE	%d
...
void into_effect(object me, string arg)
{
	...
	string * name;
	int i, size, rate, stuff, p, total, amount, sex, degree;
	...
	if (random(100)<rate)
	{
		...
		{		
			...
			"/sys/item/product"->make_item(item, FINAL_COLOR, 0);
