...
#define CPP_FILE        __DIR__ "66x.cc"
#define HTM_FILE        __DIR__ "65x.htm"
#define TEXT_FILE       __DIR__ "66x.txt"
        ...
        for( i = 0; i < size; i ++ ) 
        {
                ...
                case "紫金冠" : type = "F_ZIJINGUAN";  break;
                  ...
                  case "战盔" : type = "F_ZHANKUI";  break;
                        ...
                        log_file( LIST_LOG, sprintf( htm, name, level, "女", "桃花源<BR>蜀　山<BR>禁卫军", dp, pp, lasting / 100, lasting / 100, value ) );
                }
        }
