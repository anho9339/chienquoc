...
#define CPP_FILE        __DIR__ "88y.cc"
#define HTM_FILE        __DIR__ "88y.htm"
#define TEXT_FILE       __DIR__ "88y.txt"
...
int main( object me, string arg )
{
        ...
        for( i = 0; i < size; i ++ ) 
        {
                        ...
                        id, name, pic1, pic2, unit, level, value, lasting, dp, pp, rate1, rate2, rate3, rate4, rate5 ) )
                {
                        ...
                        log_file( LIST_LOG, sprintf( htm, name, level, "男、女", "唐　门<BR>云梦泽", dp, pp, lasting / 100, lasting / 100, value ) );
                }
        }
