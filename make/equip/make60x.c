...
#define CPP_FILE        __DIR__ "60x.cc"
#define HTM_FILE        __DIR__ "60x.htm"
#define TEXT_FILE       __DIR__ "60x.txt"
        ...
        for( i = 0; i < size; i ++ ) 
        {
                        ...
                        id, name, pic1, pic2, unit, level, value, lasting, dp, pp, hp, mp, rate, color1, color2, color3, color4, type ) )
                {
                  ...
                  case "战甲" : type = "M_ZHANJIA";  break;
                        ...
                        log_file( LIST_LOG, sprintf( htm, name, level, "男", "桃花源<BR>蜀　山<BR>禁卫军", dp, pp, lasting / 100, lasting / 100, value ) );
                }
        }
