...
#define CPP_FILE        __DIR__ "88z.cc"
#define HTM_FILE        __DIR__ "88z.htm"
#define TEXT_FILE       __DIR__ "88z.txt"
...
int main( object me, string arg )
{
        ...
        for( i = 0; i < size; i ++ ) 
        {
                        ...
                        id, name, pic1, pic2, unit, level, value, lasting, dp, pp, rate1, rate2, rate3, rate4, rate5 ) )
                {
                        ...
                        log_file( LIST_LOG, sprintf( htm, name, level, "男、女", "茅　山<BR>昆仑山", dp, pp, lasting / 100, lasting / 100, value ) );
                }
        }
