...
#define CPP_FILE        __DIR__ "66y.cc"
#define HTM_FILE        __DIR__ "65x.htm"
#define TEXT_FILE       __DIR__ "66y.txt"
        ...
        for( i = 0; i < size; i ++ ) 
        {
                ...
                case "紫金冠" : type = "F_ZIJINGUAN";  break;
                  ...
                  case "战盔" : type = "F_ZHANKUI";  break;
                        ...
                        log_file( LIST_LOG, sprintf( htm, name, level, "女", "唐　门<BR>云梦泽", dp, pp, lasting / 100, lasting / 100, value ) );
                }
        }
