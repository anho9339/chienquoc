...
#define CPP_FILE        __DIR__ "waist.cc"
#define HTM_FILE        __DIR__ "60b.htm"
#define TEXT_FILE       __DIR__ "waist.txt"
...
int main( object me, string arg )
{
        ...
        for( i = 0; i < size; i ++ ) 
        {
                ...
                if( sscanf( line[i], "%s %d %s %d %d %d %d %d", 
                        name, pic,  fam, level, value, lasting, dp, pp ) )
                {
                	dir = 87;
                	switch(fam)
                	{
                	...
                	oldid = id;
                        ...
                        log_file( file, sprintf( cpp, famtype, name, pic, pic, level, value, lasting, dp, pp, name ) );
