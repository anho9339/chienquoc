...
#define CPP_FILE        __DIR__ "lishan.cc"
#define TEXT_FILE       __DIR__ "lishan.txt"
...
int main( object me, string arg )
{
        ...
        string *item9, result_w, result_a,cWeapon;
        int i, j, total;
	int aSpe,wSpe,strong,cKind;
        ...
        for( i = 0; i < total; i ++ ) 
        {
                ...
                if( sscanf( line[i], "%d %s %d %s %d %s %d %d %s %d %d %s %s %s "
                        "%d %d %d %d %d "
                        "%d %d %d %d %d %d %d %d %d %d %d %d "
                        "%d %s %d %s %d %s %d %s", 
                        id, name, pic, task, move, sColor, level, level2, weapon[1],aSpe,wSpe,cKind,strong, cFight, 
                        r[0], r[1], r[2], money, money2, 
                        r[3], wlvl[0], r[4], alvl[0], r[5], wlvl[1], wlvl[2], wlvl[3], r[6], alvl[1], alvl[2], alvl[3], 
                        r[7], item[1], r[8], item[2], r[9], item[3], r[10], item[4] ) )
                {
...
, j, result[0] );
                        ...
                        log_file( file, sprintf( cpp, 
                                ...
                                pic, name, 
                                "FIGHTER_TYPE",   // 小怪，大怪？                                                                        
                                color, wSpe,aSpe,level, level2, cKind,strong,cWeapon,seek,
                                "FIGHTER_TYPE",   // 小怪，大怪？
                                weapon[1], weapon[2], 
                                cFight=="被动" ? "  " : "//",    // 是否主动攻击
                                task == "有" ? "  " : "//",
