...
#define CPP_FILE        __DIR__ "npc2.cc"
#define TEXT_FILE       __DIR__ "copy_boss.txt"
...
int main( object me, string arg )
{
        ...
        for( i = 0; i < total; i ++ ) 
        {
                ...
                if( sscanf( line[i], "%d %s %d %d %s %d %d %d %d %s "
                        "%d %d %d %d %d "
                        "%d %d %d %d %d %d %d %d %d %d %d %d "
                        "%d %s %d %s %d %s %d %s %d %s", 
                        id, name, pic, move, sColor, move_speed, att_speed, level, level2, weapon[1], 
