...
#define CPP_FILE        __DIR__ "npc.cc"
#define TEXT_FILE       __DIR__ "npc.txt"
...
int main( object me, string arg )
{
        ...
        for( i = 0; i < total; i ++ ) 
        {
                ...
                if( sscanf( line[i], "%d %s %d %s %d %s %d %d %s "
                        "%d %d %d %d %d "
                        "%d %d %d %d %d %d %d %d %d %d %d %d "
                        "%d %s %d %s %d %s %d %s", 
                        id, name, pic, task, move, sColor, level, level2, weapon[1], 
...
*/
                  ...
                  case "空手" : 
                  case "武器" :
                  		seek = 4;  weapon[1] = "UNARMED";  weapon[2] = "0; }    // XXXXX";  weapon[3] = "*";  break;
