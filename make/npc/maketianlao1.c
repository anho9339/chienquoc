...
#define CPP_FILE        __DIR__ "tianlao1.cc"
#define TEXT_FILE       __DIR__ "tianlao1.txt"
...
int main( object me, string arg )
{
	...
	int aSpe,wSpe,strong,cKind;
        ...
        for( i = 0; i < total; i ++ ) 
        {
                ...
                if( sscanf( line[i], "%d %s %d %s %d %s %d %d %s %d %d %s %s "
                        "%d %d %d %d %d "
                        "%d %d %d %d %d %d %d %d %d %d %d %d "
                        "%d %s %d %s %d %s %d %s", 
                        id, name, pic, task, move, sColor, level, level2, weapon[1],aSpe,wSpe,cKind,strong, 
