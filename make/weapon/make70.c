...
#define CPP_FILE        __DIR__ "70.cc"
#define HTM_FILE        __DIR__ "70.htm"
#define TEXT_FILE       __DIR__ "70.txt"
...
int main( object me, string arg )
{
        ...
        for( i = 0; i < size; i ++ ) 
        {
                        ...
                        id, num, name, pic1, pic2, unit, level, value, lasting, ap, rate1, hp, hp2, mp2 ) )
                {
                        ...
                        log_file( LIST_LOG, sprintf( htm, pic2, name, level, "男、女", "桃花源", ap, rate1, lasting / 100, lasting / 100, value ) );
                }
        }
