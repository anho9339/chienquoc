...
#define CPP_FILE        __DIR__ "40.cc"
#define HTM_FILE        __DIR__ "30.htm"
#define TEXT_FILE       __DIR__ "40.txt"
...
int main( object me, string arg )
{
        ...
        for( i = 0; i < size; i ++ ) 
        {
                ...
                if( sscanf( line[i], "%d %s %d %d %d %d %s", 
                        id, name, pic1, pic2, combined, value, desc ) )
                {
                        ...
                        log_file( file, sprintf( cpp, 
                                combined > 1 ? "  " : "//",
                                combined > 1 ? "//" : "//", combined,
                                name, pic1, pic2, range_value(value, 2, MAX_NUMBER), 
                                combined > 1 ? "  " : "//", desc ) );
