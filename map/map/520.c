...
// 函数：获取标识
int get_id() { return 520; }

// 函数：获取标识(客户端)
int get_client_id() { return 520; }

// 函数：获取名字
string get_name() { return "Tử Ngọ Cốc"; }

// 函数：复位顺序
int get_reset_order() { return 145; }
...
void create() 
{
        ...
        MAP_D->load_npc_file( map, "/map/npc/520.npc" );

        set_fighter_file( ({ "/npc/npc/0950", "/npc/npc/0951",  }) );
        set_boss_file( ({ "/npc/npc/1004", "/npc/npc/1055",  }) );
