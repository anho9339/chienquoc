...
// 函数：获取标识
int get_id() { return 332; }

// 函数：获取标识(客户端)
int get_client_id() { return 332; }

// 函数：获取名字
string get_name() { return "Hầm Vạn Nhân 2"; }

// 函数：复位顺序
int get_reset_order() { return 73; }
...
void create() 
{
        ...
        MAP_D->load_npc_file( map, "/map/npc/332.npc" );

        set_fighter_file( ({ "/npc/npc/0830", "/npc/npc/0831", "/npc/npc/0832",  }) );
        set_boss_file( ({ "/npc/npc/0900",  }) );
