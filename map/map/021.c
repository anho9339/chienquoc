...
// 函数：获取标识
int get_id() { return 021; }

// 函数：获取标识(客户端)
int get_client_id() { return 021; }

// 函数：获取名字
string get_name() { return "Tương Lăng"; }

// 函数：复位顺序
int get_reset_order() { return 16; }
...
void create() 
{
        ...
        MAP_D->load_npc_file( map, "/map/npc/021.npc" );

        set_fighter_file( ({ "/npc/npc/0220", "/npc/npc/0221", "/npc/npc/0222", "/npc/npc/0212",  }) );
        set_boss_file( ({ "/npc/npc/0262",  }) );
