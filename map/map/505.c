...
// 函数：获取标识
int get_id() { return 505; }

// 函数：获取标识(客户端)
int get_client_id() { return 505; }

// 函数：获取名字
string get_name() { return "Ô Giang"; }

// 函数：复位顺序
int get_reset_order() { return 130; }
...
void create() 
{
        ...
        MAP_D->load_npc_file( map, "/map/npc/505.npc" );

        set_fighter_file( ({ "/npc/npc/0800_1", "/npc/npc/0801_1",  }) );
        set_boss_file( ({ "/npc/npc/0858_1", "/npc/npc/0857_1",  }) );
