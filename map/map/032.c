...
// 函数：获取标识
int get_id() { return 032; }

// 函数：获取标识(客户端)
int get_client_id() { return 032; }

// 函数：获取名字
string get_name() { return "Triệu Trường Thành 2"; }

// 函数：复位顺序
int get_reset_order() { return 61; }
...
void create() 
{
        ...
        MAP_D->load_npc_file( map, "/map/npc/032.npc" );

        set_fighter_file( ({ "/npc/npc/0620_2", "/npc/npc/0621_2", "/npc/npc/0622_2",  }) );
        set_boss_file( ({ "/npc/npc/0670",  }) );
