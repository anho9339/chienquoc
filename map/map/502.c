...
// 函数：获取标识
int get_id() { return 502; }

// 函数：获取标识(客户端)
int get_client_id() { return 502; }

// 函数：获取名字
string get_name() { return "Tiểu Bái"; }

// 函数：复位顺序
int get_reset_order() { return 127; }
...
void create() 
{
        ...
        MAP_D->load_npc_file( map, "/map/npc/502.npc" );

        set_fighter_file( ({ "/npc/npc/0450_1", "/npc/npc/0451_1", "/npc/npc/0452_1",  }) );
        set_boss_file( ({ "/npc/npc/0505_1", "/npc/npc/0506_1", "/npc/npc/0507_1",  }) );
