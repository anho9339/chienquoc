...
// 函数：获取标识
int get_id() { return 515; }

// 函数：获取标识(客户端)
int get_client_id() { return 515; }

// 函数：获取名字
string get_name() { return "Dịch Kinh"; }

// 函数：复位顺序
int get_reset_order() { return 140; }
...
void create() 
{
        ...
        MAP_D->load_npc_file( map, "/map/npc/515.npc" );

        set_fighter_file( ({ "/npc/npc/0750", "/npc/npc/0751",  }) );
        set_boss_file( ({ "/npc/npc/0803", "/npc/npc/0804",  }) );
