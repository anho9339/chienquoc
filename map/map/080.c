...
// 函数：获取标识
int get_id() { return 080; }

// 函数：获取标识(客户端)
int get_client_id() { return 080; }

// 函数：获取名字
string get_name() { return "Chu"; }

// 函数：复位顺序
int get_reset_order() { return 125; }
...
void create() 
{
        ...
        MAP_D->load_npc_file( map, "/map/npc/080.npc" );
...
void reset_call_out()
{
        ...
        MAP_D->clone_fish( this_object(), CITY_ZHOU );
}
