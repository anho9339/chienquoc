...
// 函数：获取标识
int get_id() { return 012; }

// 函数：获取标识(客户端)
int get_client_id() { return 012; }

// 函数：获取名字
string get_name() { return "Bờ Đông Hải"; }

// 函数：复位顺序
int get_reset_order() { return 46; }
...
void create() 
{
        ...
        MAP_D->load_npc_file( map, "/map/npc/012.npc" );
