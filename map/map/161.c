...
// 函数：获取标识
int get_id() { return 161; }

// 函数：获取标识(客户端)
int get_client_id() { return 161; }

// 函数：获取名字
string get_name() { return "Động Đình Hồ"; }

// 函数：复位顺序
int get_reset_order() { return 4; }
...
void create() 
{
        ...
        MAP_D->load_npc_file( map, "/map/npc/161.npc" );

        set_fighter_file( ({ "/npc/npc/0050", "/npc/npc/0060", "/npc/npc/0070",  }) );
        set_boss_file( ({ "/npc/npc/0140", "/npc/npc/0141",  }) );
