...
// 函数：获取标识
int get_id() { return 091; }

// 函数：获取标识(客户端)
int get_client_id() { return 091; }

// 函数：获取名字
string get_name() { return "Thiên Môn Trận 1"; }

// 函数：复位顺序
int get_reset_order() { return 94; }
...
void create() 
{
        ...
        MAP_D->load_npc_file( map, "/map/npc/091.npc" );

        set_fighter_file( ({ "/npc/npc/1060", "/npc/npc/1061", "/npc/npc/1062",  }) );
