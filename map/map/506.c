...
// 函数：获取标识
int get_id() { return 506; }

// 函数：获取标识(客户端)
int get_client_id() { return 506; }

// 函数：获取名字
string get_name() { return "Tức Mặc"; }

// 函数：复位顺序
int get_reset_order() { return 131; }
...
void create() 
{
        ...
        MAP_D->load_npc_file( map, "/map/npc/506.npc" );

        set_fighter_file( ({ "/npc/npc/0902", "/npc/npc/0901",  }) );
        set_boss_file( ({ "/npc/npc/0953", "/npc/npc/0954",  }) );
