...
// 函数：获取标识
int get_id() { return 511; }

// 函数：获取标识(客户端)
int get_client_id() { return 511; }

// 函数：获取名字
string get_name() { return "Kỳ Liên Sơn"; }

// 函数：复位顺序
int get_reset_order() { return 136; }
...
void create() 
{
        ...
        MAP_D->load_npc_file( map, "/map/npc/511.npc" );

        set_fighter_file( ({ "/npc/npc/0601_1", "/npc/npc/0620_1", "/npc/npc/0621_1",  }) );
        set_boss_file( ({ "/npc/npc/0655_1", "/npc/npc/0657_1",  }) );
