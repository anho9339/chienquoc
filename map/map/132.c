...
// 函数：获取标识
int get_id() { return 132; }

// 函数：获取标识(客户端)
int get_client_id() { return 132; }

// 函数：获取名字
string get_name() { return "Thái Hành Sơn"; }

// 函数：复位顺序
int get_reset_order() { return 30; }

// 函数：获取地型类别
int get_map_type() { return FIELD_MAP; }

// 函数：获取投掷类数
int get_caster_amount() { return 330; }
...
void create() 
{
        ...
        MAP_D->load_npc_file( map, "/map/npc/132.npc" );
