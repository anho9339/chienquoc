...
// 函数：获取标识
int get_id() { return 546; }

// 函数：获取标识(客户端)
int get_client_id() { return 546; }

// 函数：获取名字
string get_name() { return "Thiên Ngoại Ảo Cảnh Tầng 6"; }

// 函数：复位顺序
int get_reset_order() { return 170; }
...
void create() 
{
        ...
        MAP_D->load_npc_file( map, "/map/npc/546.npc" );

        set_fighter_file( ({ "/npc/npc/1153","/npc/npc/1154",  }) );
        set_boss_file( ({ "/npc/npc/1258","/npc/npc/1259",  }) );
