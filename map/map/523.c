...
// 函数：获取标识
int get_id() { return 523; }

// 函数：获取标识(客户端)
int get_client_id() { return 523; }

// 函数：获取名字
string get_name() { return "Dương Bình Quan"; }

// 函数：复位顺序
int get_reset_order() { return 148; }
...
void create() 
{
        ...
        MAP_D->load_npc_file( map, "/map/npc/523.npc" );

        set_fighter_file( ({ "/npc/npc/1001", "/npc/npc/1002",  }) );
        set_boss_file( ({ "/npc/npc/1007", "/npc/npc/1054",  }) );
