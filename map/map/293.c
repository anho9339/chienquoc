...
// 函数：获取标识
int get_id() { return 293; }

// 函数：获取标识(客户端)
int get_client_id() { return 293; }

// 函数：获取名字
string get_name() { return "Khốn Ma Trận 3"; }

// 函数：复位顺序
int get_reset_order() { return 84; }
...
void create() 
{
        ...
        MAP_D->load_npc_file( map, "/map/npc/293.npc" );

        set_fighter_file( ({ "/npc/npc/0910", "/npc/npc/0911", "/npc/npc/0930",  }) );
        set_boss_file( ({ "/npc/npc/0990",  }) );
