...
// 函数：获取标识
int get_id() { return 503; }

// 函数：获取标识(客户端)
int get_client_id() { return 503; }

// 函数：获取名字
string get_name() { return "Bành Thành"; }

// 函数：复位顺序
int get_reset_order() { return 128; }
...
void create() 
{
        ...
        MAP_D->load_npc_file( map, "/map/npc/503.npc" );

        set_fighter_file( ({ "/npc/npc/0450", "/npc/npc/0451", "/npc/npc/0452",  }) );
        set_boss_file( ({ "/npc/npc/0505", "/npc/npc/0506", "/npc/npc/0507",  }) );
