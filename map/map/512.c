...
// 函数：获取标识
int get_id() { return 512; }

// 函数：获取标识(客户端)
int get_client_id() { return 512; }

// 函数：获取名字
string get_name() { return "Âm Sơn Thảo Nguyên"; }

// 函数：复位顺序
int get_reset_order() { return 137; }
...
void create() 
{
        ...
        MAP_D->load_npc_file( map, "/map/npc/512.npc" );

        set_fighter_file( ({ "/npc/npc/0551", "/npc/npc/0560", "/npc/npc/0561",  }) );
        set_boss_file( ({ "/npc/npc/0603", "/npc/npc/0606",  }) );
