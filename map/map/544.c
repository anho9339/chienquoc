...
// 函数：获取标识
int get_id() { return 544; }

// 函数：获取标识(客户端)
int get_client_id() { return 544; }

// 函数：获取名字
string get_name() { return "Thiên Ngoại Ảo Cảnh Tầng 4"; }

// 函数：复位顺序
int get_reset_order() { return 166; }
...
void create() 
{
        ...
        MAP_D->load_npc_file( map, "/map/npc/544.npc" );

        set_fighter_file( ({ "/npc/npc/0952",  }) );
        set_boss_file( ({ "/npc/npc/1005",  }) );
