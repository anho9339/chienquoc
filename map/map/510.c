...
// 函数：获取标识
int get_id() { return 510; }

// 函数：获取标识(客户端)
int get_client_id() { return 510; }

// 函数：获取名字
string get_name() { return "Kỳ Liên Thảo Nguyên"; }

// 函数：复位顺序
int get_reset_order() { return 135; }
...
void create() 
{
        ...
        MAP_D->load_npc_file( map, "/map/npc/510.npc" );

        set_fighter_file( ({ "/npc/npc/0601", "/npc/npc/0620", "/npc/npc/0621",  }) );
        set_boss_file( ({ "/npc/npc/0655", "/npc/npc/0657",  }) );
