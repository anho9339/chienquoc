...
// 函数：获取标识
int get_id() { return 265; }

// 函数：获取标识(客户端)
int get_client_id() { return 265; }

// 函数：获取名字
string get_name() { return "Xích Bích"; }

// 函数：复位顺序
int get_reset_order() { return 41; }
...
void create() 
{
        ...
        MAP_D->load_npc_file( map, "/map/npc/265.npc" );

        set_fighter_file( ({ "/npc/npc/0360", "/npc/npc/0361",  }) );
        set_boss_file( ({ "/npc/npc/0400",  }) );
