...
// 函数：获取标识
int get_id() { return 343; }

// 函数：获取标识(客户端)
int get_client_id() { return 343; }

// 函数：获取名字
string get_name() { return "Tướng Quân Cổ Mộ 3"; }

// 函数：复位顺序
int get_reset_order() { return 79; }
...
void create() 
{
        ...
        MAP_D->load_npc_file( map, "/map/npc/343.npc" );

        set_fighter_file( ({ "/npc/npc/0850", "/npc/npc/0851", "/npc/npc/0860", "/npc/npc/0870",  }) );
        set_boss_file( ({ "/npc/npc/0921", "/npc/npc/0922",  }) );
