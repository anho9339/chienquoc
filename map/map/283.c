...
// 函数：获取标识
int get_id() { return 283; }

// 函数：获取标识(客户端)
int get_client_id() { return 283; }

// 函数：获取名字
string get_name() { return "Hoa Sơn"; }

// 函数：复位顺序
int get_reset_order() { return 11; }
...
void create() 
{
        ...
        MAP_D->load_npc_file( map, "/map/npc/283.npc" );

        set_fighter_file( ({ "/npc/npc/0112", "/npc/npc/0113", "/npc/npc/0120",  }) );
        set_boss_file( ({ "/npc/npc/0163",  }) );
