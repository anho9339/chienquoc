...
// 函数：获取标识
int get_id() { return 539; }

// 函数：获取标识(客户端)
int get_client_id() { return 539; }

// 函数：获取名字
string get_name() { return "Địa Ngục Ma Quật Tầng 7"; }

// 函数：复位顺序
int get_reset_order() { return 171; }
...
void create() 
{
        ...
        MAP_D->load_npc_file( map, "/map/npc/539.npc" );

        set_fighter_file( ({ "/npc/npc/1203","/npc/npc/1204",  }) );
        set_boss_file( ({ "/npc/npc/1308","/npc/npc/1309",  }) );
