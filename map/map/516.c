...
// 函数：获取标识
int get_id() { return 516; }

// 函数：获取标识(客户端)
int get_client_id() { return 516; }

// 函数：获取名字
string get_name() { return "Hoằng Nông"; }

// 函数：复位顺序
int get_reset_order() { return 141; }
...
void create() 
{
        ...
        MAP_D->load_npc_file( map, "/map/npc/516.npc" );

        set_fighter_file( ({ "/npc/npc/0700", "/npc/npc/0701",  }) );
        set_boss_file( ({ "/npc/npc/0753", "/npc/npc/0754",  }) );
