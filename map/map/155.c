...
// 函数：获取标识
int get_id() { return 155; }

// 函数：获取标识(客户端)
int get_client_id() { return 155; }

// 函数：获取名字
string get_name() { return "Nhạn Môn Quan"; }

// 函数：复位顺序
int get_reset_order() { return 34; }
...
void create() 
{
        ...
        MAP_D->load_npc_file( map, "/map/npc/155.npc" );

        set_fighter_file( ({ "/npc/npc/0273", "/npc/npc/0274",  }) );
        set_boss_file( ({ "/npc/npc/0341",  }) );
