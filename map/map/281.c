...
// 函数：获取标识
int get_id() { return 281; }

// 函数：获取标识(客户端)
int get_client_id() { return 281; }

// 函数：获取名字
string get_name() { return "Triều Dương Phong"; }

// 函数：复位顺序
int get_reset_order() { return 9; }
...
void create() 
{
        ...
        MAP_D->load_npc_file( map, "/map/npc/281.npc" );

        set_fighter_file( ({ "/npc/npc/0112", "/npc/npc/0113", "/npc/npc/0121",  }) );
        set_boss_file( ({ "/npc/npc/0164",  }) );
