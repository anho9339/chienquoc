...
// 函数：获取标识
int get_id() { return 530; }

// 函数：获取标识(客户端)
int get_client_id() { return 530; }

// 函数：获取名字
string get_name() { return "Tuyết Phong Sơn Bí Đạo"; }

// 函数：复位顺序
int get_reset_order() { return 155; }
...
void create() 
{
        ...
        MAP_D->load_npc_file( map, "/map/npc/530.npc" );

        set_fighter_file( ({ "/npc/npc/0500", "/npc/npc/0501", "/npc/npc/0502",  }) );
        set_boss_file( ({ "/npc/npc/0554", "/npc/npc/0555", "/npc/npc/0556",  }) );
