...
// 函数：获取标识
int get_id() { return 112; }

// 函数：获取标识(客户端)
int get_client_id() { return 112; }

// 函数：获取名字
string get_name() { return "Chân Núi Thái Sơn"; }

// 函数：复位顺序
int get_reset_order() { return 44; }
...
void create() 
{
        ...
        MAP_D->load_npc_file( map, "/map/npc/112.npc" );

        set_fighter_file( ({ "/npc/npc/0362", "/npc/npc/0363", "/npc/npc/0364",  }) );
        set_boss_file( ({ "/npc/npc/0401",  }) );
