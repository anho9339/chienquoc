...
// 函数：获取标识
int get_id() { return 535; }

// 函数：获取标识(客户端)
int get_client_id() { return 535; }

// 函数：获取名字
string get_name() { return "Địa Ngục Ma Quật Tầng 3"; }

// 函数：复位顺序
int get_reset_order() { return 163; }
...
void create() 
{
        ...
        MAP_D->load_npc_file( map, "/map/npc/535.npc" );

        set_fighter_file( ({ "/npc/npc/0802",  }) );
        set_boss_file( ({ "/npc/npc/0856",  }) );
