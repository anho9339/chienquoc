...
// 函数：获取标识
int get_id() { return 543; }

// 函数：获取标识(客户端)
int get_client_id() { return 543; }

// 函数：获取名字
string get_name() { return "Thiên Ngoại Ảo Cảnh Tầng 3"; }

// 函数：复位顺序
int get_reset_order() { return 164; }
