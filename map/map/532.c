...
// 函数：获取标识
int get_id() { return 532; }

// 函数：获取标识(客户端)
int get_client_id() { return 532; }

// 函数：获取名字
string get_name() { return "Thượng Đảng"; }

// 函数：复位顺序
int get_reset_order() { return 157; }
...
void create() 
{
        ...
        MAP_D->load_npc_file( map, "/map/npc/532.npc" );

        set_fighter_file( ({ "/npc/npc/1050", "/npc/npc/1051",  }) );
        set_boss_file( ({ "/npc/npc/1102", "/npc/npc/1103",  }) );
