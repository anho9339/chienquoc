...
// 函数：获取标识
int get_id() { return 171; }

// 函数：获取标识(客户端)
int get_client_id() { return 171; }

// 函数：获取名字
string get_name() { return "Trường Bạch Sơn"; }

// 函数：复位顺序
int get_reset_order() { return 53; }
...
void create() 
{
        ...
        MAP_D->load_npc_file( map, "/map/npc/171.npc" );

        set_fighter_file( ({ "/npc/npc/0510", "/npc/npc/0514",  }) );
