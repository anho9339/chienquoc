...
// 函数：获取标识
int get_id() { return 509; }

// 函数：获取标识(客户端)
int get_client_id() { return 509; }

// 函数：获取名字
string get_name() { return "Thiên Thừa"; }

// 函数：复位顺序
int get_reset_order() { return 134; }
...
void create() 
{
        ...
        MAP_D->load_npc_file( map, "/map/npc/509.npc" );

        set_fighter_file( ({ "/npc/npc/0852_1", "/npc/npc/0853_1",  }) );
        set_boss_file( ({ "/npc/npc/0907_1", "/npc/npc/0904_1",  }) );
