...
// 函数：获取标识
int get_id() { return 504; }

// 函数：获取标识(客户端)
int get_client_id() { return 504; }

// 函数：获取名字
string get_name() { return "Quảng Lăng"; }

// 函数：复位顺序
int get_reset_order() { return 129; }
...
void create() 
{
        ...
        MAP_D->load_npc_file( map, "/map/npc/504.npc" );

        set_fighter_file( ({ "/npc/npc/0800", "/npc/npc/0801",  }) );
        set_boss_file( ({ "/npc/npc/0858", "/npc/npc/0857",  }) );
