...
// 函数：获取标识
int get_id() { return 282; }

// 函数：获取标识(客户端)
int get_client_id() { return 282; }

// 函数：获取名字
string get_name() { return "Đào Hoa Nguyên"; }

// 函数：复位顺序
int get_reset_order() { return 10; }
...
void create() 
{
        ...
        MAP_D->load_npc_file( map, "/map/npc/282.npc" );

        set_fighter_file( ({ "/npc/npc/0114", "/npc/npc/0115", "/npc/npc/0122",  }) );
        set_boss_file( ({ "/npc/npc/0165",  }) );
