...
// 函数：获取标识
int get_id() { return 172; }

// 函数：获取标识(客户端)
int get_client_id() { return 172; }

// 函数：获取名字
string get_name() { return "Ngọc Trụ Phong"; }

// 函数：复位顺序
int get_reset_order() { return 54; }
...
void create() 
{
        ...
        MAP_D->load_npc_file( map, "/map/npc/172.npc" );

        set_fighter_file( ({ "/npc/npc/0510", "/npc/npc/0511", "/npc/npc/0514", "/npc/npc/0512",  }) );
