...
// 函数：获取标识
int get_id() { return 081; }

// 函数：获取标识(客户端)
int get_client_id() { return 081; }

// 函数：获取名字
string get_name() { return "Thủ Dương Sơn"; }

// 函数：复位顺序
int get_reset_order() { return 13; }
...
void create() 
{
        ...
        MAP_D->load_npc_file( map, "/map/npc/081.npc" );

        set_fighter_file( ({ "/npc/npc/0160", "/npc/npc/0170",  }) );
