...
// 函数：获取标识
int get_id() { return 533; }

// 函数：获取标识(客户端)
int get_client_id() { return 533; }

// 函数：获取名字
string get_name() { return "Địa Ngục Ma Quật Tầng 1"; }

// 函数：复位顺序
int get_reset_order() { return 159; }
...
void create() 
{
        ...
        MAP_D->load_npc_file( map, "/map/npc/533.npc" );

        set_fighter_file( ({ "/npc/npc/0602",  }) );
        set_boss_file( ({ "/npc/npc/0656",  }) );
