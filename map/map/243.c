...
// 函数：获取标识
int get_id() { return 243; }

// 函数：获取标识(客户端)
int get_client_id() { return 243; }

// 函数：获取名字
string get_name() { return "Bình Nguyên"; }

// 函数：复位顺序
int get_reset_order() { return 26; }
...
void create() 
{
        ...
        MAP_D->load_npc_file( map, "/map/npc/243.npc" );

        set_fighter_file( ({ "/npc/npc/0260", "/npc/npc/0261", "/npc/npc/0272",  }) );
        set_boss_file( ({ "/npc/npc/0340",  }) );
