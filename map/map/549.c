...
// 函数：获取标识
int get_id() { return 549; }

// 函数：获取标识(客户端)
int get_client_id() { return 549; }

// 函数：获取名字
string get_name() { return "Cự Thú Đảo"; }
...
void create() 
{
        ...
        MAP_D->load_npc_file( map, "/map/npc/549.npc" );

        set_fighter_file( ({ "/npc/npc/0552", "/npc/npc/0553",  }) );
        set_boss_file( ({ "/npc/npc/0604", "/npc/npc/0605",  }) );
