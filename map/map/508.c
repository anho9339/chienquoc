...
// 函数：获取标识
int get_id() { return 508; }

// 函数：获取标识(客户端)
int get_client_id() { return 508; }

// 函数：获取名字
string get_name() { return "Cao Đường"; }

// 函数：复位顺序
int get_reset_order() { return 133; }
...
void create() 
{
        ...
        MAP_D->load_npc_file( map, "/map/npc/508.npc" );

        set_fighter_file( ({ "/npc/npc/0852", "/npc/npc/0853",  }) );
        set_boss_file( ({ "/npc/npc/0907", "/npc/npc/0904",  }) );
