...
// 函数：获取标识
int get_id() { return 342; }

// 函数：获取标识(客户端)
int get_client_id() { return 342; }

// 函数：获取名字
string get_name() { return "Tướng Quân Cổ Mộ 2"; }

// 函数：复位顺序
int get_reset_order() { return 78; }
...
void create() 
{
        ...
        MAP_D->load_npc_file( map, "/map/npc/342.npc" );

        set_fighter_file( ({ "/npc/npc/0850", "/npc/npc/0851", "/npc/npc/0860",  }) );
