...
// 函数：获取标识
int get_id() { return 542; }

// 函数：获取标识(客户端)
int get_client_id() { return 542; }

// 函数：获取名字
string get_name() { return "Thiên Ngoại Ảo Cảnh Tầng 2"; }

// 函数：复位顺序
int get_reset_order() { return 162; }
...
void create() 
{
        ...
        MAP_D->load_npc_file( map, "/map/npc/542.npc" );

        set_fighter_file( ({ "/npc/npc/0752",  }) );
        set_boss_file( ({ "/npc/npc/0805",  }) );
