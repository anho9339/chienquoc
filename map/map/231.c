...
// 函数：获取标识
int get_id() { return 231; }

// 函数：获取标识(客户端)
int get_client_id() { return 231; }

// 函数：获取名字
string get_name() { return "Trường Bình"; }

// 函数：复位顺序
int get_reset_order() { return 31; }
...
void create() 
{
        ...
        MAP_D->load_npc_file( map, "/map/npc/231.npc" );

        set_fighter_file( ({ "/npc/npc/0280", "/npc/npc/0281",  }) );
        set_boss_file( ({ "/npc/npc/0350",  }) );
