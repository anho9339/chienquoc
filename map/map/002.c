...
// 函数：获取标识
int get_id() { return 002; }

// 函数：获取标识(客户端)
int get_client_id() { return 002; }

// 函数：获取名字
string get_name() { return "U Cốc(1)"; }

// 函数：复位顺序
int get_reset_order() { return 2; }
...
void create() 
{
        ...
        MAP_D->load_npc_file( map, "/map/npc/002.npc" );

        set_fighter_file( ({ "/npc/npc/0010", "/npc/npc/0020", "/npc/npc/0021", "/npc/npc/0030",  }) );
//        set_boss_file( ({ "/npc/npc/0061",  }) );
