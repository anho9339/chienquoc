...
// 函数：获取标识
int get_id() { return 341; }

// 函数：获取标识(客户端)
int get_client_id() { return 341; }

// 函数：获取名字
string get_name() { return "Tướng Quân Cổ Mộ 1"; }

// 函数：复位顺序
int get_reset_order() { return 77; }
...
void create() 
{
        ...
        MAP_D->load_npc_file( map, "/map/npc/341.npc" );

        set_fighter_file( ({ "/npc/npc/0850", "/npc/npc/0851",  }) );
