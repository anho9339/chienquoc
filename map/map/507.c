...
// 函数：获取标识
int get_id() { return 507; }

// 函数：获取标识(客户端)
int get_client_id() { return 507; }

// 函数：获取名字
string get_name() { return "Lạc Lăng"; }

// 函数：复位顺序
int get_reset_order() { return 132; }
...
void create() 
{
        ...
        MAP_D->load_npc_file( map, "/map/npc/507.npc" );

        set_fighter_file( ({ "/npc/npc/0902_1", "/npc/npc/0901_1",  }) );
        set_boss_file( ({ "/npc/npc/0953_1", "/npc/npc/0954_1",  }) );
