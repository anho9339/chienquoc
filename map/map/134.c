...
// 函数：获取标识
int get_id() { return 134; }

// 函数：获取标识(客户端)
int get_client_id() { return 134; }

// 函数：获取名字
string get_name() { return "Sơn Động Thần Bí 2"; }

// 函数：复位顺序
int get_reset_order() { return 105; }
...
void create() 
{
        ...
        MAP_D->load_npc_file( map, "/map/npc/134.npc" );
