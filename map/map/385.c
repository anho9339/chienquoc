...
// 函数：获取标识
int get_id() { return 385; }

// 函数：获取标识(客户端)
int get_client_id() { return 385; }

// 函数：获取名字
string get_name() { return "Tử Vân Động"; }

// 函数：复位顺序
int get_reset_order() { return 89; }
