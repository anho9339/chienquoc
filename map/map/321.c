...
// 函数：获取标识
int get_id() { return 321; }

// 函数：获取标识(客户端)
int get_client_id() { return 321; }

// 函数：获取名字
string get_name() { return "Loan Đạo 1"; }

// 函数：复位顺序
int get_reset_order() { return 66; }
...
void create() 
{
        ...
        MAP_D->load_npc_file( map, "/map/npc/321.npc" );

        set_fighter_file( ({ "/npc/npc/0720", "/npc/npc/0722", "/npc/npc/0721",  }) );
        set_boss_file( ({ "/npc/npc/0762",  }) );
