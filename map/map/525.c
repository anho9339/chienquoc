...
// 函数：获取标识
int get_id() { return 525; }

// 函数：获取标识(客户端)
int get_client_id() { return 525; }

// 函数：获取名字
string get_name() { return "Tung Nguyên Bí Đạo"; }

// 函数：复位顺序
int get_reset_order() { return 150; }
...
void create() 
{
        ...
        MAP_D->load_npc_file( map, "/map/npc/525.npc" );

        set_fighter_file( ({ "/npc/npc/0650", "/npc/npc/0651", "/npc/npc/0652",  }) );
        set_boss_file( ({ "/npc/npc/0703", "/npc/npc/0706", "/npc/npc/0707", "/npc/npc/0707",  }) );
