...
// 函数：获取标识
int get_id() { return 548; }

// 函数：获取标识(客户端)
int get_client_id() { return 548; }

// 函数：获取名字
string get_name() { return "Thiên Ngoại Ảo Cảnh Tầng 8"; }

// 函数：复位顺序
int get_reset_order() { return 174; }
...
void create() 
{
        ...
        MAP_D->load_npc_file( map, "/map/npc/548.npc" );

        set_fighter_file( ({ "/npc/npc/1254",  }) );
        set_boss_file( ({ "/npc/npc/1359",  }) );
