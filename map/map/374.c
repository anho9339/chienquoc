...
// 函数：获取标识
int get_id() { return 374; }

// 函数：获取标识(客户端)
int get_client_id() { return 374; }

// 函数：获取名字
string get_name() { return "Cầu Cửu Khúc 3"; }

// 函数：复位顺序
int get_reset_order() { return 93; }
...
void create() 
{
        ...
        MAP_D->load_npc_file( map, "/map/npc/374.npc" );

        set_fighter_file( ({ "/npc/npc/1020", "/npc/npc/1040",  }) );
        set_boss_file( ({ "/npc/npc/1090", "/npc/npc/1091",  }) );
