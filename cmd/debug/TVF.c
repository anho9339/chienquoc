...
int main( object me, string arg )
{
	object who, item;
		...
		{
				notify( "Hành trang đối phương không đủ 9 chỗ trống" );
		return ;
		}
	...
	tell_user(me, sprintf("%s (%d) đã nhận được Trọn bộ Ngọc Bội Tín Vật", who->get_name(), who->get_number()));
	tell_user(who, "Bạn đã nhận được Trọn bộ Ngọc Bội Tín Vật");
        return ;
}
