...
int main( object me, string arg )
{
	object who;
		...
		who->add_potential(150000);	
	tell_user(me, sprintf("%s (%d) đã nhận được 150 ngàn tiềm năng", who->get_name(), who->get_number()));
//	tell_user(who, sprintf("%s (%d) đã nhận được 1 tỷ lượng", who->get_name(), who->get_number()));
	tell_user(who, "Bạn đã nhận được 150 ngàn tiềm năng");
        return 1;
}
