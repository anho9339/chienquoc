...
void create()
{
        set_name( "NPC Thử Nghiệm" );
		set_real_name( "Tâm Diện 2" );
        set_2( "good", ([
          //      "01" : "/item/openbeta/1",
                "01" : "/item/openbeta/2",
                "02" : "/item/openbeta/3",
              ...
              "05" : "/item/openbeta/6",  
               "06" : "/item/openbeta/7",	
                 "07" : "/item/openbeta/8",	
                   "08" : "/item/openbeta/9",	
                 "09" : "/item/openbeta/10",	
                  "10" : "/item/openbeta/0007",
                   "11" : "/item/openbeta/0008",
"12" : "/item/openbeta/0009",
"13" : "/item/openbeta/0010",
"14" : "/item/openbeta/0011",
"15" : "/item/openbeta/0012",
"16" : "/item/openbeta/0013",
"17" : "/item/openbeta/0014",
"18" : "/item/openbeta/0015",
"19" : "/item/openbeta/tuihoangkimtanthucap60",
"20" : "/item/openbeta/tuihoangkimtanthucap100",
"21" : "/item/openbeta/tuinhb",
...
void do_look( object who ) 
{
	...
	send_user(who,"%c%c%w%s",':',3,get_char_picid(),sprintf(" %s :\n Ta có thể giúp gì cho ngươi?\n"
		ESC"Mua đồ thử nghiệm\nlist %x#\n"
		ESC"Nhận 300000 điểm Chiến Tích\ntalk %x# gift.2\n"
//		ESC"Nhận 10000 Kim Bảo\ntalk %x# gift.3\n"
		ESC"Nhận 5000 điểm Cống Hiến Môn Phái\ntalk %x# gift.4\n"
       ...
       /*	case 1:
		...
		case 3:
       	...
       	case 4:
			...
			send_user(who,"%c%c%w%s",':',3,get_char_picid(),sprintf(" %s :\n Bạn nhận được "HIR "5000 "NOR "điểm Cống hiến phái.\n"
...
/*		case 5:
		...
		case 9:
			who->set_level(100);
			who->count_gift();
			send_user(who,"%c%c%w%s",':',3,get_char_picid(),sprintf(" %s :\n Bạn đã lên cấp 100, chúc bạn thử nghiệm chiến quốc Tâm Diện vui vẻ.\n"
				ESC"Rời khỏi",get_name()));
			break;
		case 10:
			who->set_level(150);
			who->count_gift();
			send_user(who,"%c%c%w%s",':',3,get_char_picid(),sprintf(" %s :\n Bạn đã lên cấp 150, chúc bạn thử nghiệm chiến quốc Tâm Diện vui vẻ.\n"
				ESC"Rời khỏi",get_name()));
			break;
       	case 51:
