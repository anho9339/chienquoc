...
void do_look( object who )
{
	...
	tmp += sprintf(ESC"Mua phương pháp phân phối cấp 1-30 kỹ năng điêu khắc\nlist %s\n", me->get_char_id());
	if ( sizeof(tmp) )
		send_user(who,"%c%c%w%s",':',3,40000,sprintf( " %s :\n Ở chỗ ta Ngươi có thể học được hết những kỹ năng điêu khắc đá mà Ngươi học ở nước Sở, nhưng phương pháp pha chế cao cấp thì Ngươi phải mua ở chỗ những Công tượng của nước Sở.\n",get_name(),getoid(me)) +
		tmp +
		ESC"Rời khỏi");
	else
		send_user(who,"%c%c%w%s",':',3,40000,sprintf( " %s :\n Ở chỗ ta Ngươi có thể học được hết những kỹ năng điêu khắc đá mà Ngươi học ở nước Sở, nhưng phương pháp pha chế cao cấp thì Ngươi phải mua ở chỗ những Công tượng của nước Sở.\n",get_name()));
