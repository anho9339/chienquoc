...
void create()
{
        set_name("Bán Buôn Năm Mới");
		set_name("Thuật Phong");
        set_2( "talk", ([
				"gift"          : (: do_gift :),
        ]));
...
void do_gift2( object me, string arg )
{
	...
	iGio = mxTime[TIME_HOUR];
		...
		case 16:
		case 17:
			if ( flag==14 ) {bennhat="item/event/tuihoangkim";bennhat2=20;bn2=10;}
			else if ( flag==15 ) {bennhat="item/event/tuikimbao";bennhat2=15;bn2=20;}
			else if ( flag==16 ) {bennhat="item/event/tuinganluong";bennhat2=10;bn2=20;}
