...
void create()
{
        ...
        NPC_ENERGY_D->init_level( this_object(), 27+ random(4) );    // 
        set_max_seek(4);
...
//      p = random(100);  size = ( p > 2 ) ? 1 : ( p > 0 ) ? 2 : 8;  total = 2;  total2 = 3;
        ...
        for( i = 0; i < size; i ++ )
        {
                ...
                if( p < 2550 * rate / 100 ) ;    // NONE

                else if( p < 7510 * rate / 100 )    // 金钱
                {
...
/*              else if( p < 9400 * rate / 100 )    // 杂物１
                ...
                else if( p < 10000 * rate / 100 )    // 杂物２
                {
                       ...
                       case 1 : file = "/item/31/3150";  break;
                       case 2 : file = "/item/stuff/0044";  break;
                       case 3 : file = "/item/91/9100";  break;
