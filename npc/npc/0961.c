...
void check_legend_task( object who )
{
	...
	if( who->get_legend(TASK_33, 1) && !who->get_legend(TASK_33, 2) && who->get_save("ltmuj") < 7 )
	{
		...
		send_user(who,"%c%s",'!',sprintf(HIY"Mộc Tinh %d/7",i));		
	}
