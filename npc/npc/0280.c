...
void create()
{
        ...
        set_head_color(0x6820);

        NPC_ENERGY_D->init_level( this_object(), 28+ random(3) );    // 
        set_max_seek(4);
...
//      p = random(100);  size = ( p > 40 ) ? 3 : 10;  total = 2;  total2 = 3;
        ...
        for( i = 0; i < size; i ++ )
        {
                ...
                if( p < 4616 * rate / 100 ) ;    // NONE

/*              else if( p < 4616 * rate / 100 )    // 金钱
                {
...
/*              else if( p < 4616 * rate / 100 )    // 防具(基本)
                ...
                else if( p < 9850 * rate / 100 )    // 杂物２
                {
                        switch( random(3) )
                        {
                       case 0 : file = "/item/41/4107";  break;
