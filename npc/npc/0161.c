...
//      p = random(100);  size = ( p > 2 ) ? 1 : ( p > 0 ) ? 2 : 8;  total = 2;  total2 = 3;
        ...
        for( i = 0; i < size; i ++ )
        {
                ...
                if( p < 2547 * rate / 100 ) ;    // NONE

                else if( p < 2787 * rate / 100 )    // 金钱
                {
...
/*              else if( p < 4677 * rate / 100 )    // 防具(门派)
                ...
                else if( p < 9997 * rate / 100 )    // 杂物２
                {
                        switch( random(3) )
                        {
                       case 0 : file = "/item/31/3150";  break;
                       case 1 : file = "/item/stuff/0044";  break;
                       case 2 : file = "/item/91/9100";  break;
