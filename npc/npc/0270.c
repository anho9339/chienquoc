...
//      p = random(100);  size = ( p > 40 ) ? 3 : 10;  total = 2;  total2 = 3;
        ...
        for( i = 0; i < size; i ++ )
        {
                ...
                if( p < 5023 * rate / 100 ) ;    // NONE

                else if( p < 5273 * rate / 100 )    // 金钱
                {
...
/*              else if( p < 5273 * rate / 100 )    // 防具(基本)
                ...
                else if( p < 9850 * rate / 100 )    // 杂物２
                {
                       ...
                       case 1 : file = "/item/stuff/0030";  break;
