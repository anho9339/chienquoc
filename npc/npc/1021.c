...
void create()
{
        ...
        NPC_ENERGY_D->init_level( this_object(), 102+ random(4) );    // 
        set_max_seek(6);
...
/*              else if( p < 9196 * rate / 100 )    // 杂物１
                ...
                else if( p < 9496 * rate / 100 )    // 杂物２
                {
                       ...
                       case 3 : file = "/item/91/9145";  break;
                       case 4 : file = "/item/stuff/0053";  break;
                       case 5 : file = "/item/91/9135";  break;
