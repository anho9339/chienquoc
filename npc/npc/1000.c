...
//      p = random(100);  size = ( p > 2 ) ? 1 : ( p > 0 ) ? 2 : 8;  total = 2;  total2 = 3;
        ...
        for( i = 0; i < size; i ++ )
        {
                ...
                if( p < 2436 * rate / 100 ) ;    // NONE

                else if( p < 8116 * rate / 100 )    // 金钱
                {
                        ...
                        if( p = get_valid_xy(z, x, y, IS_ITEM_BLOCK) )
                        {
                                ...
                                item->set_value( 1000 + random(240) );
...
/*              else if( p < 9196 * rate / 100 )    // 杂物１
                ...
                else if( p < 9496 * rate / 100 )    // 杂物２
                {
                        switch( random(9) )
                        {
                       case 0 : file = "/item/91/9140";  break;
                       case 1 : file = "/item/91/9121";  break;
                       case 2 : file = "/item/91/9120";  break;
                       case 3 : file = "/item/stuff/0130";  break;
                       case 4 : file = "/item/91/9145";  break;
                       case 5 : file = "/item/stuff/0053";  break;
                       case 6 : file = "/item/stuff/0051";  break;
                       case 7 : file = "/item/stuff/0049";  break;
                       case 8 : file = "/item/91/9135";  break;
