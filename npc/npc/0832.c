...
void check_legend_task( object who )
{
	...
	if( who->get_legend(TASK_28, 26) && !who->get_legend(TASK_28, 27) && who->get_save("zgdjjsuangdaokl") < 8)
	{
		...
		send_user(who,"%c%s",'!',sprintf(HIY"Song Đao Khô Lâu %d/8",i));		
	}
