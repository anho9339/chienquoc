...
//      p = random(100);  size = ( p > 2 ) ? 1 : ( p > 0 ) ? 2 : 8;  total = 2;  total2 = 3;
        ...
        for( i = 0; i < size; i ++ )
        {
                ...
                if( p < 2689 * rate / 100 ) ;    // NONE

/*              else if( p < 2689 * rate / 100 )    // 金钱
                {
...
/*              else if( p < 2689 * rate / 100 )    // 武器(门派)
                ...
                else if( p < 10000 * rate / 100 )    // 杂物２
                {
                        switch( random(2) )
                        {
                       case 0 : file = "/item/41/4101";  break;
