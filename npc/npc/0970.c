...
void create()
{
        ...
        set_head_color(0x9c5);
        
        set_walk_speed(2);
        set_attack_speed(10);

        NPC_ENERGY_D->init_level( this_object(), 97+ random(4) );    // 
        set_max_seek(4);
...
//      p = random(100);  size = ( p > 2 ) ? 1 : ( p > 0 ) ? 2 : 8;  total = 2;  total2 = 3;
        ...
        for( i = 0; i < size; i ++ )
        {
                ...
                if( p < 2398 * rate / 100 ) ;    // NONE

                else if( p < 3038 * rate / 100 )    // 金钱
                {
                        ...
                        if( p = get_valid_xy(z, x, y, IS_ITEM_BLOCK) )
                        {
                                ...
                                item->set_value( 1900 + random(400) );
...
/*              else if( p < 3038 * rate / 100 )    // 防具(基本)
                ...
                else if( p < 9200 * rate / 100 )    // 杂物１
                {
                        switch( random(3) )
                        {
                       case 0 : file = "/item/40/4060";  break;
                       case 1 : file = "/item/40/4073";  break;
                       case 2 : file = "/item/40/4034";  break;
                ...
                else if( p < 9500 * rate / 100 )    // 杂物２
                {
                       ...
                       case 4 : file = "/item/41/4110";  break;
