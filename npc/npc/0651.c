...
//      p = random(100);  size = ( p > 40 ) ? 3 : 10;  total = 2;  total2 = 3;
        ...
        for( i = 0; i < size; i ++ )
        {
                ...
                if( p < 7158 * rate / 100 ) ;    // NONE

                else if( p < 8958 * rate / 100 )    // 金钱
                {
