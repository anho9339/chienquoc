...
void create()
{
        set_name("Thạch Dũng Tinh Nhuệ");

        set_char_type(FIGHTER_TYPE_2);    // init_level 要用到
        
        set_head_color(0x49e5);
