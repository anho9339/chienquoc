...
//      p = random(100);  size = ( p > 2 ) ? 1 : ( p > 0 ) ? 2 : 8;  total = 2;  total2 = 3;
        ...
        for( i = 0; i < size; i ++ )
        {
                ...
                if( p < 3580 * rate / 100 ) ;    // NONE

/*              else if( p < 3580 * rate / 100 )    // 金钱
                {
...
/*              else if( p < 4120 * rate / 100 )    // 防具(门派)
                ...
                else if( p < 9480 * rate / 100 )    // 杂物１
                {
                        switch( random(1) )
                        {
                       case 0 : file = "/item/40/4036";  break;
                ...
                else if( p < 10000 * rate / 100 )    // 杂物２
                {
                        switch( random(1) )
                        {
                       case 0 : file = "/item/stuff/0106";  break;
