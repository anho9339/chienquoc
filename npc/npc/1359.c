...
void create()
{
        set_name("Thiên Ngoại Thần Tướng Quân");
...
/*              else if( p < 6700 * rate / 100 )    // 防具(基本)
                ...
                else if( p < 7600 * rate / 100 )    // 武器(门派)
                {
                        ...
                        switch( random(3) )
                        {
                       case 0 : file = WEAPON_FILE->get_weapon_file_2(120);  break;
                       case 1 : file = WEAPON_FILE->get_weapon_file_2(120);  break;
                ...
                else if( p < 8500 * rate / 100 )    // 防具(门派)
                {
                        ...
                        switch( random(3) )
                        {
                       case 0 : file = ARMOR_FILE->get_armor_file_2(120);  break;
                       case 1 : file = ARMOR_FILE->get_armor_file_2(120);  break;
...
/*              else if( p < 8500 * rate / 100 )    // 杂物１
                ...
                else if( p < 10000 * rate / 100 )    // 杂物４
                {
                        switch( random(2) )
                        {
                       case 0 : file = "/item/stuff/0015";  break;
