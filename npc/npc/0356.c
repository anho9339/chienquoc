...
//      p = random(100);  size = ( p > 2 ) ? 1 : ( p > 0 ) ? 2 : 8;  total = 2;  total2 = 3;
        ...
        for( i = 0; i < size; i ++ )
        {
                ...
                if( p < 2684 * rate / 100 ) ;    // NONE

                else if( p < 7884 * rate / 100 )    // 金钱
                {
...
/*              else if( p < 9478 * rate / 100 )    // 杂物１
                ...
                else if( p < 9998 * rate / 100 )    // 杂物２
                {
                       ...
                       case 3 : file = "/item/41/4101";  break;
