...
void create()
{
        set_name("Thiết Chuỳ Tướng Quân");
...
/*              else if( p < 6300 * rate / 100 )    // 防具(基本)
                ...
                else if( p < 7200 * rate / 100 )    // 武器(门派)
                {
                       ...
                       case 1 : file = WEAPON_FILE->get_weapon_file_2(75);  break;
                ...
                else if( p < 8100 * rate / 100 )    // 防具(门派)
                {
                       ...
                       case 1 : file = ARMOR_FILE->get_armor_file_2(75);  break;
                ...
                else if( p < 8500 * rate / 100 )    // 杂物１
                {
                        switch( random(1) )
                        {
                       case 0 : file = "/quest/product2"->get_random_level_product(70,70);  break;
