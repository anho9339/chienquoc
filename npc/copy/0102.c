...
void create()
{
        set_name("Ngu Vương Tàn Phách");

        set_char_type(FIGHTER_TYPE_2);    // init_level 要用到
        
        set_head_color(0x861);
        
        set_walk_speed(2);
        set_attack_speed(10);

        NPC_ENERGY_D->init_level( this_object(), 45+ random(4) );    // 
        set_max_seek(4);
...
/*              else if( p < 2553 * rate / 100 )    // 防具(基本)
                ...
                else if( p < 9796 * rate / 100 )    // 杂物２
                {
                       ...
                       case 2 : file = "/item/41/4101";  break;
