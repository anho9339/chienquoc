...
void create()
{
        set_name("Lương Vương Tàn Phách");

        set_char_type(FIGHTER_TYPE_2);    // init_level 要用到
        
        set_head_color(0x3000);
...
//      p = random(100);  size = ( p > 2 ) ? 1 : ( p > 0 ) ? 2 : 8;  total = 2;  total2 = 3;
        ...
        for( i = 0; i < size; i ++ )
        {
                ...
                if( p < 2389 * rate / 100 ) ;    // NONE

                else if( p < 3029 * rate / 100 )    // 金钱
                {
                        ...
                        if( p = get_valid_xy(z, x, y, IS_ITEM_BLOCK) )
                        {
                                ...
                                item->set_value( 1650 + random(350) );
...
/*              else if( p < 3029 * rate / 100 )    // 防具(基本)
                ...
                else if( p < 9346 * rate / 100 )    // 杂物１
                {
                       ...
                       case 2 : file = "/item/40/4062";  break;
                ...
                else if( p < 9796 * rate / 100 )    // 杂物２
                {
                       ...
                       case 3 : file = "/item/41/4110";  break;
