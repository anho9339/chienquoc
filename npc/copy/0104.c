...
void create()
{
        set_name("Thái Vương Tàn Phách");

        set_char_type(FIGHTER_TYPE_2);    // init_level 要用到
        
        set_head_color(0x32a4);
        
        set_walk_speed(2);
        set_attack_speed(10);

        NPC_ENERGY_D->init_level( this_object(), 55+ random(4) );    // 
        set_max_seek(4);
...
//      p = random(100);  size = ( p > 2 ) ? 1 : ( p > 0 ) ? 2 : 8;  total = 2;  total2 = 3;
        ...
        for( i = 0; i < size; i ++ )
        {
                ...
                if( p < 2456 * rate / 100 ) ;    // NONE

                else if( p < 3096 * rate / 100 )    // 金钱
                {
                        ...
                        if( p = get_valid_xy(z, x, y, IS_ITEM_BLOCK) )
                        {
                                ...
                                item->set_value( 1100 + random(100) );
...
/*              else if( p < 3096 * rate / 100 )    // 防具(基本)
                ...
                else if( p < 9276 * rate / 100 )    // 杂物１
                {
                        switch( random(2) )
                        {
                       case 0 : file = "/item/40/4049";  break;
                       case 1 : file = "/item/40/4015";  break;
                ...
                else if( p < 9796 * rate / 100 )    // 杂物２
                {
                       ...
                       case 1 : file = "/item/31/3151";  break;
                       case 2 : file = "/item/31/3152";  break;
