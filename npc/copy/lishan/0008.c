...
void check_legend_task( object who )
{
	...
	if( who->get_legend(TASK_2_00, 28) && !who->get_legend(TASK_2_00, 29) && who->get_save("fb_sx_qlky") < 10 )
	{
		if ( (i=who->add_save("fb_sx_qlky",1)) >= 10 && who->get_save("fb_sx_qlgj") >= 12 )
		{
		...
		send_user(who,"%c%s",'!',sprintf(HIY"Tần Lăng Khổ Dịch %d/10",i));		
	}
}
