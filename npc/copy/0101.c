...
void create()
{
        set_name("Kỷ Vương Tàn Phách");

        set_char_type(FIGHTER_TYPE_2);    // init_level 要用到
        
        set_head_color(0x30a2);
        
        set_walk_speed(2);
        set_attack_speed(10);

        NPC_ENERGY_D->init_level( this_object(), 40+ random(4) );    // 
        set_max_seek(4);
...
//      p = random(100);  size = ( p > 2 ) ? 1 : ( p > 0 ) ? 2 : 8;  total = 2;  total2 = 3;
        ...
        for( i = 0; i < size; i ++ )
        {
                ...
                if( p < 1913 * rate / 100 ) ;    // NONE

                else if( p < 2553 * rate / 100 )    // 金钱
                {
...
/*              else if( p < 2553 * rate / 100 )    // 防具(基本)
                ...
                else if( p < 3195 * rate / 100 )    // 武器(门派)
                {
                       ...
                       case 1 : file = WEAPON_FILE->get_weapon_file_2(35);  break;
                ...
                else if( p < 3836 * rate / 100 )    // 防具(门派)
                {
                       ...
                       case 1 : file = ARMOR_FILE->get_armor_file_2(35);  break;
                ...
                else if( p < 9276 * rate / 100 )    // 杂物１
                {
                        switch( random(2) )
                        {
                       case 0 : file = "/item/40/4009";  break;
                       case 1 : file = "/item/40/4006";  break;
                ...
                else if( p < 9796 * rate / 100 )    // 杂物２
                {
                       ...
                       case 2 : file = "/item/stuff/0032";  break;
                       case 3 : file = "/item/41/4107";  break;
