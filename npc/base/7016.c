...
void do_talk_exchange()
{
	TASK_COLLECT_D->do_talk_exchange( this_player(), this_object(), 7016 );
}
...
void do_exchange(string sArg)
{
	TASK_COLLECT_D->do_exchange(sArg,7016);
}
...
void do_inputx(string sArg)
{
	object me,who;
	me = this_object(); who = this_player();
	TASK_COLLECT_D->do_inputx(me,who,sArg,7016);
}
