...
int perform_action( object who ) 
{
	...
	{
		set_skill(0241,23);
		return "skill/02/02413"->perform_action_npc(me,who);	//千里奔袭
	}
	else if ( rate < 35 )
	{
		set_skill(0241,28);
	...
	{
		set_skill(0211,18);
		return "skill/02/02115"->perform_action_npc(me,who);	//粘手
	}
	else if ( rate < 50 )
	{
		set_skill(0211,40);
		return "skill/02/02118"->perform_action_npc(me,who);	//大海无量
	}
