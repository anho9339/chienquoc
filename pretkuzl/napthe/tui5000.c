...
{ 
        return "Túi Quà Cảm Ơn trị giá 5.000.000.";
}
...
{
	int gender,family,type,z,x,c,v,b,n,m,a,s,d,f,g,h,j,k,l,q;
	...
	who->add_cash(4000000);
		...
		// Set túi đoạn thạch
		item1 = new("pretkuzl/napthe/tuisetdt5");
	a = item1->move2(who,-1);
		item1->add_to_user(a);
	...
	s = item2->move2(who,-1);
		...
		item10 = new("item/sell/4032");
	q = item10->move2(who,-1);
		item10->add_to_user(q);
	...
	k = item8->move2(who,-1);
		item8->add_to_user(k);
         ...
         item9 = new("item/TuiLinhThach/NgauNhien/7");		
	    item9->set_amount(4);
	l = item9->move2(who,-1);
		item9->add_to_user(l);		  
