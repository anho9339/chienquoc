...
{ 
        return "Set bao gồm 5 đoạn thạch mỗi loại.";
}
...
{
	int gender,family,type,z,x,c,v,b,n,m,a,s,d,f,g,h,j,k,l,r,q,w,e;
	...
	TASK_LEGEND_D->check_task_item17(who,"Set Đoạn Thạch",1);
	TASK_LEGEND_D->check_task_item18(who,"Set Đoạn Thạch",1);
	TASK_LEGEND_D->check_task_item19(who,"Set Đoạn Thạch",1); 
	TASK_LEGEND_D->check_task_item20(who,"Set Đoạn Thạch",1);
	...
	v = item4->move2(who,-1);
		...
		item17 = new("item/sell/0032");
	q = item17->move2(who,-1);
		item17->add_to_user(q);
	...
	a = item8->move2(who,-1);
		...
		item18 = new("item/sell/1032");
	w = item18->move2(who,-1);
		item18->add_to_user(w);
	...
	g = item12->move2(who,-1);
		...
		item19 = new("item/sell/2032");
	e = item19->move2(who,-1);
		item19->add_to_user(e);
	...
	l = item16->move2(who,-1);
		...
		item20 = new("item/sell/0034");
	r = item20->move2(who,-1);
		item20->add_to_user(r);
