...
{ 
        return "Túi Quà Đại Đệ Tử, chỉ có đại đệ tử mới được mở.";
}
...
int get_use_effect_callout( object who,object gift) 
{
	...
	TASK_LEGEND_D->check_task_item1(who,"Túi Quà Đại Đệ Tử",1);
	TASK_LEGEND_D->check_task_item2(who,"Túi Quà Đại Đệ Tử",1); 
